...
struct GoalItemService {
    ...
    static func writeKeystoneGoals(for user: User, success: @escaping (Bool) -> Void) {
        ...
        let keystone3 = GoalItem(name: "🔑 Meditate", why: "Meditation is correlated with increased memory and awareness and reduced stress and anxiety", timestamp: currentDate, count: 0)
