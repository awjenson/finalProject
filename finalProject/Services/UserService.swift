...
struct UserService {
    ...
    // need a service method that will retrieve all of a user's posts from Firebase. This will be the data that we display in our timeline.
    // we have a method that will fetch and return all of our posts from Firebase from a given user.
