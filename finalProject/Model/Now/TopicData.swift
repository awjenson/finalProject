...
let brunchTip6 = Tip(header: "Healthy Choice 🥔", title: "For sides, choose either whole-grain toast or the potatoes — not both", body: "Otherwise, you end up with too many carbs on your plate. In place of potatoes, ask for fruit or a side salad to add some low-calorie, high nutritional value to your meal. And avoid home fries and hash browns which are likely deep-fried and covered in butter and oil." , sourceName: "Everyday Health", sourceURL: "https://www.everydayhealth.com/pictures/what-to-order-at-brunch/#06", doneType: "", buyURL: "")
...
let dinnerTip44 = Tip(header: "Prevent Overeating 🙅‍♀️📺", title: "Don't watch TV, listen to radio, or read a book while eating", body: "Anything distracting and enjoyable increases overeating. \n\nSolution: Put the food back in the cupboard or refrigerator or on the stove. You can have seconds, but you'll have to walk for it." , sourceName: "Slim By Design", sourceURL: "https://www.slimbydesign.com/", doneType: "", buyURL: "")
...
//5
let cafeTip21 = Tip(header: "Increase Happiness 😄", title: "Study: People who made small talk with their barista felt happier than those who stayed silent", body: "Humans are designed to have social interaction. These small interactions are incredibly important for our overall well-being. \n\nSmile, make eye contact, and have brief but genuine conversation." , sourceName: "Business Insider", sourceURL: "https://www.businessinsider.com/how-to-make-sure-get-happier-as-you-get-older-2019-8", doneType: "", buyURL: "")
...
//WIP 1
let cafeTipArray5 = [cafeTip21, cafeTip20, cafeTip16, cafeTip12]
//
...
//4
let cafePMTip13 = Tip(header: "Sleep Better 😴", title: "In the evening, avoid caffeine in: \n🍵 Tea \n☕️ Coffee  \n🥤 Energy drinks or colas", body: "Caffeine interferes with the process of falling asleep, and also prevents deep sleep. Instead, have a warm, milky drink or herbal tea." , sourceName: "NHS", sourceURL: "https://www.nhs.uk/live-well/sleep-and-tiredness/10-tips-to-beat-insomnia/", doneType: "", buyURL: "")
...
let movieTheaterTip2 = Tip(header: "", title: "Want popcorn? Buy the medium or large popcorn, not the extra-large popcorn", body: "Study: Moviegoers ate 45% more popcorn from extra-large containers than large ones." , sourceName: "Eat This, Not That!", sourceURL: "https://www.eatthis.com/things-making-you-fatter/", doneType: "", buyURL: "")
