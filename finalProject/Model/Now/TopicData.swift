...
//5
let breakfastTip17 = Tip(header: "", title: "Breakfast foods that reduce anxiety", body: "Oatmeal, oranges, blueberries, milk and almond butter.", sourceName: "Men's Journal", sourceURL: "https://www.mensjournal.com/food-drink/eat-to-beat-stress-10-foods-that-reduce-anxiety/8-spinach-2/", sponsorLogo: "", sponsorURL: "")
...
let breakfastTipArray4 = [breakfastTip17, breakfastTip2, breakfastTip3, breakfastTip4]
...
let brunchTipArray2 = [brunchTip1, brunchTip2, brunchTip3, brunchTip4]
...
let brunchTipArray5 = [brunchTip5, brunchTip6, brunchTip7, brunchTip8]
let brunchTopic5 = Topic(title: brunchTitle, icon: brunchIcon, tip: brunchTipArray5)

let brunchTipArray6 = [brunchTip7, brunchTip8, brunchTip3, brunchTip4]
...
let lunchTipArray6 = [lunchTip25, lunchTip26, lunchTip27, lunchTip16]
...
let dinnerTip36 = Tip(header: "", title: "Don’t heat your fats - butter, avocado oil, olive oil, coconut oil - to what is called their \"smoke point.\"", body: "This is where healthy fats start to turn unhealthy, because once they burn, they start to produce toxic compounds. \n\nPro Tip: Cook with Avocado Oil \n\nIt has the highest smoke point of all cooking oils (a smoke point above 500º F.", sourceName: "Own The Day, Own Your Life", sourceURL: "https://www.amazon.com/dp/B072HLS5QJ/", sponsorLogo: "", sponsorURL: "")

//9
let dinnerTip37 = Tip(header: "", title: "Eat slowly. Study: Fast eaters are up to 115% more likely to be obese", body: "Another study: People who ate \"very fast\" tended to be heavier and had gained the most bodyweight since age 20. \n\nPut simply, overweight people chew less than normal-weight people, because when you chew more, you tend to eat less - 15% less, in one study." , sourceName: "Own The Day, Own Your Life", sourceURL: "https://www.amazon.com/dp/B072HLS5QJ/", sponsorLogo: "TBD", sponsorURL: "www.test.com")
let dinnerTip38 = Tip(header: "", title: "The best time for eating bread is dinner, after your glycogen stores have been depleted by exercise, and you're about to head sleep", body: "So if bread and butter is your thing, eat it at dinner, with grass-fed button on sprouted or sourdough.", sourceName: "Own The Day, Own Your Life", sourceURL: "https://www.amazon.com/dp/B072HLS5QJ/", sponsorLogo: "", sponsorURL: "")
...
let dinnerTipArray9 = [dinnerTip37, dinnerTip38, dinnerTip3, dinnerTip4]
let dinnerTopic9 = Topic(title: dinnerTitle, icon: dinnerIcon, tip: dinnerTipArray9)

let dinnerTipArray10 = [dinnerTip5, dinnerTip6, dinnerTip7, dinnerTip8]
let dinnerTopic10 = Topic(title: dinnerTitle, icon: dinnerIcon, tip: dinnerTipArray10)

let dinnerTipArray11 = [dinnerTip9, dinnerTip10, dinnerTip11, dinnerTip12]
...
//5
let dinnerAfter9PMTipArray5 = [dinnerAfter9PM5, dinnerAfter9PM6, dinnerAfter9PM7, dinnerAfter9PM8]
...
//2
let afternoonSnackTipArray2 = [afternoonSnackTip9, afternoonSnackTip10, afternoonSnackTip11, afternoonSnackTip6]
let afternoonSnackTopic2 = Topic(title: afternoonSnackTitle, icon: afternoonSnackIcon, tip: afternoonSnackTipArray2)

//3
let afternoonSnackTipArray3 = [afternoonSnackTip1, afternoonSnackTip2, afternoonSnackTip3, afternoonSnackTip4]
...
//5
let afternoonSnackTipArray5 = [afternoonSnackTip9, afternoonSnackTip10, afternoonSnackTip11, afternoonSnackTip6]
let afternoonSnackTopic5 = Topic(title: afternoonSnackTitle, icon: afternoonSnackIcon, tip: afternoonSnackTipArray5)

//6
let afternoonSnackTipArray6 = [afternoonSnackTip5, afternoonSnackTip6, afternoonSnackTip7, afternoonSnackTip8]
...
let lateNightSnackTipArray2 = [lateNightSnackTip9, lateNightSnackTip8, lateNightSnackTip7, lateNightSnackTip6]
...
let lateNightSnackTipArray5 = [lateNightSnackTip9, lateNightSnackTip8, lateNightSnackTip7, lateNightSnackTip6]
...
let gymTip24 = Tip(header: "👍", title: "Framing exercise as \"fun\" instead of \"exercise\" reduces the number of unhealthy foods consumed afterward", body: "Study: When we view exercise as something we do for fun, we’re better at resisting unhealthy foods afterward. But when the same physical activity is perceived as a chore, we have a much harder time saying no to fattening foods.", sourceName: "Harvard Business Review", sourceURL: "https://hbr.org/2014/10/regular-exercise-is-part-of-your-job", sponsorLogo: "", sponsorURL: "")

//6
let gymTip25 = Tip(header: "", title: "Exercise to music. A study of athletes found that their endurance increased by 20% when running in sync with the rhythms of the track, compared with trials when they exercised in silence", body: "Exercising in sync to a musical rhythm helps us produce more efficient movements, with less energy. Moving in sync to music can increase the release of endorphins, which helps increase your pain threshold.", sourceName: "BBC News", sourceURL: "http://www.bbc.com/culture/story/20190729-what-songs-make-you-work-out-harder", sponsorLogo: "", sponsorURL: "")
let gymTip26 = Tip(header: "🏋️‍♀️", title: "Work out with weights first and cardio last", body: "Your body is better able to handle weight training early in the workout because you're fresh and have the energy you need. \n\nCardio exercise should be last because it helps your body recover by increasing blood flow to the muscles, and flushing out lactic acid that was built up from weight lifting. The lactic acid is what makes your muscles feel stiff and sore.", sourceName: "Health24", sourceURL: "https://www.health24.com/Medical/Flu/Health-tips/45-best-health-tips-ever-20120721", sponsorLogo: "", sponsorURL: "")
...
let gymTip47 = Tip(header: "", title: "Exercise to fast tempo music. Study: Fast tempo music automatically causes our heart’s rhythm to increase by 5-15 beats per minute. It also triggers the release of adrenaline that helps prime the body for greater physical effort", body: "Combined with motivational lyrics, the physiological response could put you in the perfect physical and mental state to exercise harder and get into a state of flow.", sourceName: "BBC News", sourceURL: "http://www.bbc.com/culture/story/20190729-what-songs-make-you-work-out-harder", sponsorLogo: "", sponsorURL: "")
...
let gymTip50 = Tip(header: "🤔", title: "Research shows practicing visualization helps you perform better", body: "Scientists found that weight lifters who visualized their workouts were nearly 2 times stronger than those who did nothing at all. Basically, you're helping your brain establish patterns for success. \n\nClose your eyes and quickly run through your workout in your head beforehand.", sourceName: "The Thirty", sourceURL: "https://thethirty.byrdie.com/mindfulness-tips-ideas", sponsorLogo: "LOGO", sponsorURL: "URL")
...
let runningTip2 = Tip(header: "🏃‍♀️", title: "Run faster by adding short sprints into your endurance training on a regular basis", body: "You won’t make performance gains if you always run at the same speed. Work short speedwork into one of your long-distance runs to vary the pace. \n\nSteadily increase your running speed from a recovery pace to a sprint over a distance of 80-100 meters." , sourceName: "Runtastic", sourceURL: "https://www.runtastic.com/blog/en/5-effective-tips-for-improving-your-running-performance/", sponsorLogo: "TBD", sponsorURL: "www.test.com")
...
let runningTip4 = Tip(header: "🏃‍♂️", title: "Take short effective strides to conserve energy and reduce joint pain", body: "Stand tall and lean forward, and when you feel like you are going to fall, step forward just enough to catch yourself. \n\nThis should be the length of your stride. Taking long strides while you run is inefficient and an energy drain." , sourceName: "Shape", sourceURL: "https://www.shape.com/fitness/cardio/10-ways-improve-your-running-technique", sponsorLogo: "TBD", sponsorURL: "www.test.com")
...
let runningTip6 = Tip(header: "👟", title: "If you’re training for and running half/full marathons, don’t do it in cheap shoes. Invest in a custom-fit pair of running shoes", body: "When you're training for half/full marathons, the difference with custom-fit shoes and cheap shoes will be noticeable. Custom-fit shoes will reduce callouses and help reduce soreness in your feet and knees.", sourceName: "Medium", sourceURL: "https://medium.com/runners-life/should-i-buy-expensive-running-shoes-9bb60af20df5", sponsorLogo: "", sponsorURL: "")
...
let AMRoutine18 = Tip(header: "📓", title: "If you want to become the voice of your generation, write a journal entry every day and then gift it to your local university library at the end of your life", body: "David McCullough, the Pulitzer Prize-winning author, said a journal is one of the most precious gifts you can give to those you leave behind.", sourceName: "Greg McKeown, author of Essentialism: The Disciplined Pursuit of Less", sourceURL: "https://gregmckeown.com/blog/one-thing-productive-people-reaching-phones/", sponsorLogo: "", sponsorURL: "")
let AMRoutine19 = Tip(header: "", title: "Denzel Washington: I try to give myself a goal every day", body: "Dreams, without goals, are just dreams. \n\nSo have dreams, but have goals, life goals, yearly goals, monthly goals, daily goals. \n\nTo achieve these goals you must apply discipline and consistency. You have to work at it every day. You have to plan every day.", sourceName: "Fearless Motivation", sourceURL: "https://www.fearlessmotivation.com/2018/09/23/denzel-washington-speech/", sponsorLogo: "", sponsorURL: "")
...
let AMRoutineTipArray0 = [AMRoutine0, AMRoutine1, AMRoutine2, AMRoutine3]//SUN, WEEK 1
let AMRoutineTipArray1 = [AMRoutine4, AMRoutine5, AMRoutine6, AMRoutine7]//SAT, WEEK 1
let AMRoutineTipArray2 = [AMRoutine8, AMRoutine9, AMRoutine10, AMRoutine11]//SUN, WEEK 2
let AMRoutineTipArray3 = [AMRoutine12, AMRoutine13, AMRoutine14, AMRoutine15]//SAT, WEEK
...
//WEEK 2
let AMRoutineTipArray7 = [AMRoutine28, AMRoutine21, AMRoutine16, AMRoutine19]
...
let AMRoutineTipArray10 = [AMRoutine8, AMRoutine9, AMRoutine10, AMRoutine11]//SUN, WEEK 2
let AMRoutineTipArray11 = [AMRoutine12, AMRoutine13, AMRoutine14, AMRoutine15]//SAT, WEEK
...
let goingOutTipArray4 = [goingOutTip17, goingOutTip18, goingOutTip11, goingOutTip12]
...
let safetyTip12 = Tip(header: "🚶‍♂️", title: "Carry yourslef with confidence", body: "Walk with your head up. Not only will it help you see what is happening around you, but it will give you an air of confidence that will prevent assailants from approaching you as a weak and easy target." , sourceName: "wikiHow", sourceURL: "https://www.wikihow.com/Stay-Safe-at-Night", sponsorLogo: "", sponsorURL: "")
//4
...
let cafeTip4 = Tip(header: "🍵", title: "Green tea increases metabolism to help you burn fat and helps to decrease cancer risk", body: "To get higher levels of cancer-fighting antioxidants, it's best to brew tea yourself and drink it hot. Iced tea and ready-to-drink green teas have less antioxidants." , sourceName: "WebMD", sourceURL: "https://www.webmd.com/hepatitis/ss/slideshow-best-and-worst-foods-for-your-liver", sponsorLogo: "TBD", sponsorURL: "www.test.com")
...
let cafeTip7 = Tip(header: "🔥", title: "Drinking coffee, tea and other beverages at temperatures hotter than 149 degrees Fahrenheit may lead to esophagus cancer", body: "Beverages that are too hot can injure cells in the esophagus and lead to the formation of cancer cells. But, scientists said coffee at cooler temperatures is safe to drink and may decrease the risk of liver cancer by 15%." , sourceName: "USA Today", sourceURL: "https://www.usatoday.com/story/news/2016/06/15/who-drinking-extremely-hot-coffee-tea-probably-causes-cancer/85923476/", sponsorLogo: "TBD", sponsorURL: "www.test.com")
let cafeTip8 = Tip(header: "☕️", title: "Coffee may help prevent diseases like stroke and certain cancers, lower risk of Parkinson's and dementia, and boost concentration and memory", body: "But, remember: caffeine is a drug and can become an addiction. Experts say 400 milligrams of caffeine a day is a safe amount — about the amount in four 8-ounce cups of coffee." , sourceName: "Mayo Clinic", sourceURL: "https://www.mayoclinic.org/healthy-lifestyle/nutrition-and-healthy-eating/in-depth/caffeine/art-20045678", sponsorLogo: "", sponsorURL: "")
...
let cafeTipArray4 = [cafeTip17, cafeTip18, cafeTip19, cafeTip12]
...
// AM Break
// 0
let breakAMTip1 = Tip(header: "🧠", title: "Top performers take a 17-minute break every 52 minutes", body: "One study found the top 10% of productive people all worked an average of 52 minutes before taking a 17-minute break. Working for any longer can cause cognitive boredom. \n\nBy knowing you have a break coming up, you’re more likely to stay focused and work with purpose. And taking regular breaks will improve your health." , sourceName: "Fast Company", sourceURL: "https://www.fastcompany.com/40475204/youre-taking-breaks-the-wrong-way-heres-how-to-fix-that", sponsorLogo: "TBD", sponsorURL: "www.test.com")
...
//0
let groceryStoreTip1 = Tip(header: "🍎", title: "Eat healthy before you shop and you're less likely to buy junk food", body: "Research found that shoppers who ate a small healthy snack before shopping filled their carts with 25% more fruits and vegetables than if they didn't eat a healthy snack.  \n\nHealthy eating before buying food primes your brain for the decisions you'll make inside the supermarket." , sourceName: "Cornell University", sourceURL: "https://foodpsychology.cornell.edu/discoveries/apple-day-brings-more-apples-your-way", sponsorLogo: "TBD", sponsorURL: "www.test.com")

let groceryStoreTip2 = Tip(header: "😀", title: "Practice kindness: Buy a bag of good groceries and donate it to your local food bank or shelter", body: "Most good deeds don't require the amount of time and organization you think they do. The thing that will surprise you the most is how good you'll feel about it." , sourceName: "Canadian Living", sourceURL: "https://www.canadianliving.com/health/mind-and-spirit/article/50-good-deeds-for-50-days", sponsorLogo: "", sponsorURL: "")

let groceryStoreTip3 = Tip(header: "🍳", title: "Eating more protein is a great way to lose weight and belly fat", body: "Protein has been shown to reduce food cravings, boost metabolism, and help you eat fewer calories per day. Protein foods to buy include: eggs, seafood, legumes, nuts, meat, dairy products, and some whole grains." , sourceName: "HealthLine", sourceURL: "https://www.healthline.com/nutrition/how-protein-can-help-you-lose-weight", sponsorLogo: "TBD", sponsorURL: "www.test.com")
let groceryStoreTip4 = Tip(header: "🛒", title: "There are lots of germs in a supermarket. Use the hand sanitizer when you walk out of the store or wash your hands when you get home", body: "The germiest things include: shopping carts, the produce, meat, and seafood aisles, credit card and self-checkout touch screens, and your reusable bag." , sourceName: "Today", sourceURL: "https://www.today.com/food/10-germiest-things-grocery-store-how-stay-safe-t109564", sponsorLogo: "TBD", sponsorURL: "www.test.com")
...
let groceryStoreTip16 = Tip(header: "💐", title: "Make someone happy today by surprising them with flowers", body: "In one study, 100% of the participants who received flowers responded with a true smile indicating happiness. While only 90% and 77% of the participants who received a fruit basket and candle, respectively, responded with a true smile. In addition, only the participants who received the flowers reported a longer term increase in positive mood.", sourceName: "SAGE Journals", sourceURL: "https://journals.sagepub.com/doi/full/10.1177/147470490500300109", sponsorLogo: "", sponsorURL: "")
...
let groceryStoreTip20 = Tip(header: "😀", title: "Practice kindness: Let the person in line behind you go first", body: "People who practice kindness as a habit have 23% less cortisol (the stress hormone). And studies have shown that developing a habit of kindness reduces pain, anxiety, and depression." , sourceName: "Inc.", sourceURL: "https://www.inc.com/scott-mautz/want-to-spread-joy-at-work-this-month-try-these-31-random-acts-of-christmas-kind.html", sponsorLogo: "", sponsorURL: "")
...
//6
let groceryStoreTip25 = Tip(header: "🛒", title: "Use a basket to avoid overspending", body: "Shopping carts were strategically designed to influence larger purchases. With a large shopping cart, consumers are less likely to realize the quantity of goods they're actually buying." , sourceName: "Business Insider", sourceURL: "https://www.businessinsider.com/build-these-10-shopping-habits-to-save-big-2012-3", sponsorLogo: "", sponsorURL: "")

let groceryStoreTip26 = Tip(header: "🙅‍♀️", title: " If you want to eat healthfully, avoid the center aisles - that's where the stores try to get consumers to buy the highly profitable junk foods", body: "To eat healhty, focus on the foods at the periphery of the store, where the meat, fish, dairy, and produce are located.", sourceName: "UC Berkeley News", sourceURL: "https://www.berkeley.edu/news/berkeleyan/2006/04/13_nestle.shtml", sponsorLogo: "", sponsorURL: "")

let groceryStoreTip27 = Tip(header: "⏱", title: "Reduce impulse purchases by shopping for less than 23 minutes", body: "Brain scans reveal that consumers only act rationally for the first 23 minutes of shopping. Afterwards, the emotional part of the brain becomes more active which is not good at making money-based decisions.", sourceName: "BBC News", sourceURL: "https://www.bbc.com/news/uk-wales-north-west-wales-24995031", sponsorLogo: "", sponsorURL: "")

let groceryStoreTip28 = Tip(header: "😀", title: "Practice kindness: If you're in line with a full cart, let the person behind you who only has 5-10 items go in front of you", body: "Most good deeds don't require the amount of time and organization you think they do. The thing that will surprise you the most is how good you'll feel about it." , sourceName: "Canadian Living", sourceURL: "https://www.canadianliving.com/health/mind-and-spirit/article/50-good-deeds-for-50-days", sponsorLogo: "", sponsorURL: "")
...
let groceryStoreTip30 = Tip(header: "💐", title: "Boost your mood by buying flowers for your home", body: "Researchers found that the presence of plants in the home makes people feel less stressed and more compassionate toward others. Results from the study suggests that placing a few flowers in your home can make you more relaxed and improve your mood." , sourceName: "The Harvard Crimson", sourceURL: "https://www.thecrimson.com/article/2006/10/26/a-bouquet-a-day-a-new/", sponsorLogo: "", sponsorURL: "")
...
let groceryStoreTip34 = Tip(header: "", title: "Live longer: Buy vegetables that are darker green or red because they tend to have more nutrients than lighter varieties", body: "Leafy greens are low in sodium and calories, and they are completely cholesterol-free. A healthy plant-based diet has been associated with: \n• an extra decade of life expectancy \n• a reduced risk of diabetes and heart disease.", sourceName: "The Blue Zones: 9 Lessons For Living Longer", sourceURL: "https://www.amazon.com/Blue-Zones-Lessons-Living-Longest/dp/1426207557", sponsorLogo: "", sponsorURL: "")
...
let groceryStoreTipArray10 = [groceryStoreTip13, groceryStoreTip14, groceryStoreTip15, groceryStoreTip16]
let groceryStoreTipArray11 = [groceryStoreTip17, groceryStoreTip18, groceryStoreTip19, groceryStoreTip20]
...
let shoppingClothesTip6 = Tip(header: "👕", title: "Simplify your day and reduce decision fatigue: buy a work uniform", body: "Steve Jobs, Mark Zuckerberg, and Dr. Dre all use work uniforms. Having a regular uniform makes it quick and easy to get dressed. You can conserve all that decision-making power directly towards more important decisions. \n\nA go-to work uniform saves you time shopping. You know what you're looking for and can get right to your favorite store. Or, if you know your size, style, and color, you can order everything online." , sourceName: "Inc.", sourceURL: "https://www.inc.com/craig-bloem/this-1-unusual-habit-helped-make-mark-zuckerberg-steve-jobs-dr-dre-successful.html", sponsorLogo: "TBD", sponsorURL: "www.test.com")
...
let shoppingClothesTip8 = Tip(header: "😀", title: "Study: People feel happier when they buy something for someone else than when they buy something for themselves", body: "This happiness boost was the same regardless of whether the gift cost $20 or $100. Doing good deeds for others makes people happier, and makes them more likely to do more good deeds in the future." , sourceName: "The Greater Good Science Center at UC Berkeley", sourceURL: "https://greatergood.berkeley.edu/article/item/kindness_makes_you_happy_and_happiness_makes_you_kind", sponsorLogo: "", sponsorURL: "")
...
//4
let shoppingClothesTipArray4 = [shoppingClothesTip17, shoppingClothesTip18, shoppingClothesTip11, shoppingClothesTip12]
let shoppingClothesTopic4 = Topic(title: shoppingClothesTitle, icon: shoppingClothesIcon, tip: shoppingClothesTipArray4)

//6
let shoppingClothesTipArray5 = [shoppingClothesTip5, shoppingClothesTip6, shoppingClothesTip7, shoppingClothesTip8]
...
let commuteAMTip6 = Tip(header: "🤔", title: "Spend 5-10 minutes thinking and planing out your day", body: "Think hour by hour. What will make this day a success? With whom are you meeting? What are you trying to accomplish? What might throw you off? How will you handle it? Do you expect to have any difficult conversations? How will you approach them? Any risks you want to take? How will you initiate them? ", sourceName: "Harvard Business Review", sourceURL: "https://hbr.org/2015/01/get-more-done-during-your-commute", sponsorLogo: "Sponsor", sponsorURL: "sponsorURL")
...
let commuteAMTip23 = Tip(header: "", title: "Study: Elevator buttons in public spaces like office buildings could be harboring more germs than toilet seats", body: "Clean it: Maybe you don’t want to stand around your office building and wipe down the elevator buttons. But you’ll probably want to wash, or at least sanitize, your hands once you’ve reached your floor.", sourceName: "Reader's Digest", sourceURL: "https://www.rd.com/home/cleaning-organizing/germs-toilet-seat/", sponsorLogo: "", sponsorURL: "")
...
let workAMTip3 = Tip(header: "📵", title: "Be more productive at work by placing your cell phone out of sight or face-down", body: "A study found people were much more likely to make errors and not pay attention to their main task if they were interrupted by notifications from their phone - such as a text or a call.", sourceName: "WIRED", sourceURL: "https://www.wired.co.uk/article/what-is-productivity-be-more-productive-how-to-work", sponsorLogo: "TBD", sponsorURL: "www.test.com")
...
let workAMTipArray13 = [workAMTip53, workAMTip34, workAMTip35, workAMTip36]
let workAMTopic13 = Topic(title: workAMTitle, icon: workAMIcon, tip: workAMTipArray13)

let workAMTipArray14 = [workAMTip37, workAMTip38, workAMTip39, workAMTip40]
...
//FRI
let workPMTipArray14 = [workPMTip57, workPMTip58, workPMTip59, workPMTip40]
...
let homeAMTipArray2 = [homeAMTip1, homeAMTip2, homeAMTip3, homeAMTip4]
let homeAMTopic2 = Topic(title: homeAMTitle, icon: homeAMIcon, tip: homeAMTipArray2)

let homeAMTipArray3 = [homeAMTip5, homeAMTip6, homeAMTip7, homeAMTip8]
let homeAMTopic3 = Topic(title: homeAMTitle, icon: homeAMIcon, tip: homeAMTipArray3)

let homeAMTipArray4 = [homeAMTip1, homeAMTip2, homeAMTip3, homeAMTip4]
...
let homeAMTipArray6 = [homeAMTip8, homeAMTip7, homeAMTip6, homeAMTip5]
...
let homePMTipArray9 = [homePMTip37, homePMTip38, homePMTip39, homePMTip32]
let homePMTopic9 = Topic(title: homePMTitle, icon: homePMIcon, tip: homePMTipArray9)

let homePMTipArray10 = [homePMTip5, homePMTip6, homePMTip7, homePMTip8]
...
let bedtimeTip2 = Tip(header: "💪", title: "Wake up early tomorrow and exercise. Don't think. Just execute the plan.", body: "One of the most common ways to sabotage your morning is to get a slow start by gradually waking up and doing tasks that require thinking. \n\nInstead, wake up early, jump out of bed, and puts on the workout clothes you prepared the night before. By the time you've finished your workout, most people are just waking up." , sourceName: "Jocko Willink, retired Navy SEAL commander", sourceURL: "https://www.businessinsider.com/jocko-willink-how-to-wake-up-earlier-2017-11", sponsorLogo: "TBD", sponsorURL: "www.test.com")
...
let bedtimeTip4 = Tip(header: "📝", title: "Reduce decision fatigue tomorrow by making a plan tonight", body: "List the major tasks you want to accomplish the next day — and how you want to spend the first few hours of the day. \n\nLay out the clothes you’ll wear and have ingredients ready to make a healthy breakfast. Making fewer decisions in the morning helps you have more willpower later in the day." , sourceName: "NBC News", sourceURL: "https://www.nbcnews.com/better/health/9-things-do-morning-make-your-whole-day-more-productive-ncna772446", sponsorLogo: "TBD", sponsorURL: "www.test.com")
...
//FRI AM (see PM above) (WIP)
let bedtimeTipArray12 = [bedtimeTip49, bedtimeTip50, bedtimeTip24, bedtimeTip23]
...
let eveningRoutineIcon = Constants.Icon.routine
...
let eveningRoutineTipArray5 = [eveningRoutine20,  eveningRoutine9, eveningRoutine10, eveningRoutine11]
...
//2
let restaurantTip9 = Tip(header: "🍕", title: "Diners leave 17% of their meals uneaten and 55% of edible leftovers are left at the restaurant", body: "Portion sizes have increased significantly over the past 30 years. The average pizza slice has grown 70% in calories, the average chicken caesar salad doubled in calories, and the average chocolate chip cookie has quadrupled. Today, portion sizes can be 2 to 8 times larger than USDA or FDA standard serving sizes." , sourceName: "CNBC", sourceURL: "https://www.cnbc.com/2015/04/22/americas-165-billion-food-waste-problem.html", sponsorLogo: "TBD", sponsorURL: "www.test.com")
let restaurantTip10 = Tip(header: "🤔", title: "Be alert. Diners seated in darker rooms order dishes with 39% more calories than diners in brighter rooms", body: "Research found that people eating in well-lit spaces are 16%-24% more likely to order healthy dishes than those in dimly lit rooms, due to a higher level of alertness." , sourceName: "Food & Wine", sourceURL: "https://www.foodandwine.com/blogs/dim-lighting-makes-you-eat-more-restaurants", sponsorLogo: "", sponsorURL: "")
...
//5
let restaurantTip21 = Tip(header: "", title: "Research: Eating less meat and more vegetables can help fight climate change", body: "58% of all food emissions come from animal products. Eating meat contributes to global warming through the methane gas the animals produce, but also via deforestation to expand pastures. \n\nRising temperatures, increased rain and more extreme weather events will all have a negative impact on crops and livestock.", sourceName: "BBC News", sourceURL: "https://www.bbc.com/news/science-environment-49238749", sponsorLogo: "", sponsorURL: "")
...
//6
let restaurantTipArray6 = [restaurantTip13, restaurantTip14, restaurantTip15, restaurantTip16]
...
let travelTip9 = Tip(header: "", title: "I have found out that there ain't no surer way to find out whether you like people or hate them than to travel with them.", body: "- Mark Twain \n\nMark Twain was an American writer, humorist, and entrepreneur.", sourceName: "Wonderful Quote", sourceURL: "https://www.wonderfulquote.com/l/relationships-quotes", sponsorLogo: "", sponsorURL: "")
