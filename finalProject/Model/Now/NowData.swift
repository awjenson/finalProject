...
//WEEK 5
let weekendNow5to8Tip28 = Tip(header: "Reduce Your Risk 🏃‍♀️", title: "Study: Exercising in the morning linked to lower cancer risk", body: "Participants who regularly exercised between 8:00 a.m. and 10:00 a.m. enjoyed the highest risk decreases for prostate cancer and breast cancer. \n\nExercising early in the day appears to disrupt the overproduction of hormones associated with various forms of cancer." , sourceName: "Ladders", sourceURL: "https://www.theladders.com/career-advice/exercising-at-this-specific-time-of-day-linked-to-lower-cancer-risk", doneBool: false, doneKey: "", buyURL: "")
...
let weekendNow5to8Tip30 = Tip(header: "Health Skin 🏋️‍♀️", title: "Exercise. Not exercising leads to unhealthy skin and an increase in age spots", body: "Exercise helps increase blood flow and gives your face a healthy glow. \n\nIn addition, it also cleans the body of toxins, which are expelled during perspiration, and cleanses dead skins cells allowing new ones to grow." , sourceName: "Redbook Magazine", sourceURL: "https://www.redbookmag.com/beauty/makeup-skincare/g4004/surprising-things-ruin-skin/?slide=24", doneBool: false, doneKey: "", buyURL: "")

let weekendNow5to8Tip31 = Tip(header: "Lose Belly Fat 🚶‍♀️", title: "Take a brisk walk before breakfast", body: "Study: Exposure to sunlight in between the hours of 8 a.m. and noon reduces your risk of weight gain. \n\nAnd burning calories before you eat means you're exercising in a fasted state—the energy you burn comes right from your fat stores, instead of the food you ate.", sourceName: "Eat This, Not That!", sourceURL: "https://www.eatthis.com/14-ways-lose-your-belly-14-days/", doneBool: false, doneKey: "", buyURL: "")
...
//WED
let weekdayNow5to8Tip48 = Tip(header: "Win the Morning Battle 💪", title: "David Goggins: \"I wake up and go for a run every day. Why? Because you have to do something that sucks every single day.\"", body: "Once you overcome the suck, then you're powerful and now now you're ready to battle the rest of the day." , sourceName: "YouTube: David Goggins Morning Routine", sourceURL: "https://www.youtube.com/watch?v=nMPRYZdG_ow", doneBool: false, doneKey: "", buyURL: "")

let weekdayNow5to8Tip49 = Tip(header: "Burn 20% More Fat", title: "Exercise 🏃‍♀️ in the morning, before breakfast 🍳", body: "When you first wake up, having not eaten for several hours, your blood surgar is low. \n\nSince you need blood sugar to fuel a run, morning exercise will use the fat stored in your tissues to supply the energy you need. \n\nHowever, when you exercise after eating, you use the energy from the food you've just consumed. \n\nIn many cases, morning exercise may burn 20% more fat than later, post-food workouts.", sourceName: "When: The Scientific Secrets of Perfect Timing", sourceURL: "https://www.amazon.com/gp/product/B072Q985YX/", doneBool: false, doneKey: "", buyURL: "")
let weekdayNow5to8Tip50 = Tip(header: "Prevent Weight Gain ⌚️", title: "Limit your daily eating window to 10 hours - So, if you take your first bite of food at 8 a.m., you'd need to consume your last calorie of the day by 6 p.m.", body: "In a 3-month study, overweight participants who ate in a 10 hour window saw: \n\n• 3% reduction in their weight \n• 4% reduction in abdominal visceral fat \n\nDuring the fasting period, participants were encouraged to stay hydrated with water.", sourceName: "NPR", sourceURL: "https://www.npr.org/sections/thesalt/2019/12/08/785142534/eat-for-10-hours-fast-for-14-this-daily-habit-prompts-weight-loss-study-finds", doneBool: false, doneKey: "", buyURL: "")
...
let weekdayNow9to11Tip19 = Tip(header: "Millionaire Habit 💰", title: "Write down a to-do list for today 📝", body: "Those who maintain both a calendar and to-do list are 289% more likely to be millionaires, as compared with those who have no real set schedule. \n\nHigh-achievers have clear goals, specific plans, and hard deadlines. And when you’re setting goals, don’t be afraid to think big.", sourceName: "CNBC", sourceURL: "https://www.cnbc.com/2018/07/05/habits-to-start-if-you-want-to-get-rich.html", doneBool: false, doneKey: "", buyURL: "")
...
//TUES
let weekdayNow11to14Tip23 = Tip(header: "Live Longer 💪", title: "Add more movement into your life by: \n• Living in walkable neighborhoods 🚶‍♀️ \n• Commuting to places by bike 🚴‍♀️  \n• Planting a garden 👩‍🌾", body: "Study of 100+ year-olds in Greece: They exercised mindlessly, by gardening, walking to their neighbor's house, or doing yard work.", sourceName: "The Blue Zones: 9 Lessons For Living Longer", sourceURL: "https://www.amazon.com/Blue-Zones-Lessons-Living-Longest/dp/1426207557", doneBool: false, doneKey: "", buyURL: "")
...
let mondayNow21to24Week1Tip2 = Tip(header: "Increase Success 🤓", title: "Prepare for tomorrow with a pre-bedtime routine", body: "• 👕 Layout tomorrow's outfit \n• 🎽 Layout gym clothes \n• 🥗 Prepare a healthy lunch \n\nA little prep work will help ease the morning rush." , sourceName: "mindbodygreen, a lifestyle media brand", sourceURL: "https://www.mindbodygreen.com/0-20168/a-nighttime-ritual-for-deep-restful-sleep.html", doneBool: false, doneKey: "", buyURL: "www.test.com")
...
//FRI
let weekdayNow21to24Tip36 = Tip(header: "Sleep Better 😴", title: "Avoid alcohol, cigarettes, caffeine, and heavy meals in the evening 🍺🚬☕️🍔", body: "Alcohol, cigarettes, and caffeine can disrupt sleep. Eating big or spicy meals can cause discomfort from indigestion that can make it hard to sleep. \n\nAvoid eating large meals 2-3 hours before bedtime. Try a light snack 45 minutes before bed if you’re still hungry." , sourceName: "National Sleep Foundation", sourceURL: "https://www.sleepfoundation.org/articles/healthy-sleep-tips", doneBool: false, doneKey: "", buyURL: "www.google.com")
