...
//// WED
let weekdayNow0to4Tip8 = Tip(header: "", title: "People who were more active at night were 6% to 10% more likely to be diagnosed with a mood disorder, like depression, study finds", body: "Every biological process, from eating to sleeping, is controlled by the body's circadian rhythms. Irregular circadian rhythms confuse the body, and they've been linked to mood disorders and weight gain. Scientists also discovered that night owls tended to be lonelier and more unhappy.", sourceName: "Men's Health", sourceURL: "https://www.menshealth.com/health/a20716425/circadian-rhythms-depression-mood-disorders/", sponsorLogo: "", sponsorURL: "")
...
let weekdayNow0to4TipArray2 = [weekdayNow0to4Tip8, weekdayNow0to4Tip4, weekdayNow0to4Tip6, weekdayNow0to4Tip7]
...
let weekdayNow5to8Tip22 = Tip(header: success, title: "", body: "" , sourceName: "", sourceURL: "", sponsorLogo: "", sponsorURL: "")
...
let weekdayNow17to20Tip9 = Tip(header: success, title: "Your willpower is limited, which is why, after a long day at the office, we're more likely to indulge in unhealthy foods and desserts", body: "In a Stanford University experiment, students were divided into two groups. One group was given a two-digit number to remember, while the second group was given a seven-digit number. Then they were told to walk down the hall, where they were presented with two different snack options: a slice of chocolate cake or a bowl of fruit salad. The students with seven digits to remember were twice as likely to choose the cake as students given two digits. The reason is that those extra numbers took up valuable space in the brain-the prefront cortex-making it that much harder to resist a dessert." , sourceName: "The Wall Street Journal", sourceURL: "https://www.wsj.com/articles/SB10001424052748703478704574612052322122442", sponsorLogo: "", sponsorURL: "")
let weekdayNow17to20Tip10 = Tip(header: success, title: "Many highly successful people say they read before bed", body: "Microsoft co-founder Bill Gates reads for an hour before bed. His reading topics range from healthcare to climate change to business and politics." , sourceName: "Business Insider", sourceURL: "https://www.businessinsider.com/why-executives-read-before-bed-2017-9", sponsorLogo: "", sponsorURL: "")
let weekdayNow17to20Tip11 = Tip(header: success, title: "Research confirms people who are mistreated at work are at a higher risk of doing the same to loved ones at the end of the day", body: "Making time for exercise and getting more sleep can stop the downward spiral of stress and burnout. A study found participants who took 10,900 steps each day were less likely to be abusive toward family members when compared to participants who took 7,000 steps. They found burning an additional 587 calories could reduce the harmful effects of mistreatment. For the average American male, that means an hour of swimming or a brisk 90-minute walk." , sourceName: "Forbes", sourceURL: "https://www.forbes.com/sites/amymorin/2017/06/10/how-to-leave-stress-at-work-so-you-dont-take-out-your-frustration-on-your-family/#14ff2f584b48", sponsorLogo: "", sponsorURL: "")
//// THU
