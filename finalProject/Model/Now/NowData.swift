...
let weekday0Now5to8Tip2 = Tip(header: "Getting Ready", title: "Choose an outfit that you feel \"great\" in because it can boost your mood, self-confidence, and productivity", body: "Clothes do affect how we work and act. In one experiment, a group of students were given a set of tasks to do — half were given a doctor’s lab coat to wear and half were not. Those wearing the coats were more attentive and focused than those not wearing the coats.", sourceName: "NBC News", sourceURL: "https://www.nbcnews.com/better/business/can-wearing-work-uniform-help-you-get-ahead-ncna788136?cid=eml_better_20180716", sponsorLogo: "", sponsorURL: "")
