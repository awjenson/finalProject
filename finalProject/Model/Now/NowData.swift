...
// SUN
let weekendNow0to4TipArray0 = [sundayNow0to4Tip0, sundayNow0to4Tip1, sundayNow0to4Tip2, sundayNow0to4Tip3]
let weekendNow0to4Topic0 = Topic(title: weekendNow0to4Title, icon: weekendNow0to4Icon, tip: weekendNow0to4TipArray0)

// SAT (WIP)
let weekendNow0to4TipArray1 = [saturdayNow0to4Tip0, sundayNow0to4Tip1, sundayNow0to4Tip2, sundayNow0to4Tip3] // add 3 more
...
let weekendNow5to8Tip0 = Tip(header: beMoreProductive, title: "The best time to do your best work is during the first 3 hours of your day", body: "Your brain is most active and creative immediately following sleep. So, the first 3 hours of your day are your most precious for maximized focus and productivity." , sourceName: "Medium", sourceURL: "https://medium.com/@benjaminhardy/this-morning-routine-will-save-you-20-hours-per-week-409f8acbde1", sponsorLogo: "TBD", sponsorURL: "www.test.com")
...
//2
// TODO: WIP
let saturdayNow17to20Tip4 = Tip(header: weekendNow17to20Title, title: "Saturday from 4:00 p.m. to 10:00 p.m. is the most dangerous day and time of the week to drive", body: "An analysis of US car crash-related fatalities in 2016 found that Saturday during the late afternoon and evening had the most fatal car creashes compared to any other day and time during the week. Alcohol and speeding are key factors in the increased crash risk on Saturday." , sourceName: "Avvo", sourceURL: "https://www.avvo.com/fatal-car-accidents", sponsorLogo: "TBD", sponsorURL: "www.test.com")
...
// SUNDAY (WIP)
let weekendNow17to20TipArray1 = [sundayNow17to20Tip0, sundayNow17to20Tip1, sundayNow17to20Tip2, weekendNow17to20Tip1]
...
let weekdayNow17to20Tip2 = Tip(header: success, title: "Increase wellbeing by saying: \"I am enough\"", body: "The repetition of this simple phrase (both out loud and in your head) will eventually make it difficult for your mind to object to it. It will improve your confidence and outlook on life." , sourceName: "Marisa Peer, author of Ultimate Confidence", sourceURL: "https://www.marisapeer.com/i-am-enough-marisa/", sponsorLogo: "TBD", sponsorURL: "www.test.com")
...
//TUE
let weekdayNow17to20TipArray1 = [weekdayNow17to20Tip4, weekdayNow17to20Tip5, weekdayNow17to20Tip6, weekdayNow17to20Tip7]
...
//THU (WIP)
let weekdayNow17to20TipArray3 = [weekdayNow17to20Tip12, weekdayNow17to20Tip13, weekdayNow17to20Tip10, weekdayNow17to20Tip11]
let weekdayNow17to20Topic3 = Topic(title: weekdayNow17to20Title, icon: weekdayNow17to20Icon, tip: weekdayNow17to20TipArray3)

//FRI (WIP)
let weekdayNow17to20TipArray4 = [weekdayNow17to20Tip14, weekdayNow17to20Tip9, weekdayNow17to20Tip10, weekdayNow17to20Tip11]
