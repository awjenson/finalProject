...
var weekendNow5to8TipArray3 = [weekendNow5to8Tip12, weekendNow5to8Tip13, weekendNow5to8Tip6, weekendNow5to8Tip7]
...
//WEEK 2
//SUN
let sundayNow9to11Tip1 = Tip(header: "", title: "Live longer: Attending a spiritual service at least once a month reduces your risk of death by a third, study finds", body: "People who attend a spirital service have a forced schedule of self-reflection, decompression, and stress-relieving meditation, either through regular prayer or from sitting quietly during spirital services. \n\nIf you don't subscribe to any specific denomination, or if you haven't found a positive spirital experience, you may want to explore a belief that is not based on strict dogma.", sourceName: "The Blue Zones: 9 Lessons For Living Longer", sourceURL: "https://www.amazon.com/Blue-Zones-Lessons-Living-Longest/dp/1426207557", sponsorLogo: "", sponsorURL: "")
...
//WEEK 2
//SUN
let weekendNow9to10TipArray3 = [sundayNow9to11Tip1, sundayNow9to11Tip2, sundayNow9to11Tip3, sundayNow9to11Tip4]//WIP
let sunday9to10Topic2 = Topic(title: weekendNow9to11Title, icon: weekendNow9to11Icon, tip: weekendNow9to10TipArray3)

//SAT
let weekendNow9to10TipArray2 = [saturdayNow9to11Tip1, saturdayNow9to11Tip2, saturdayNow9to11Tip3, weekendNow9to11Tip4]
...
let weekendNow11to14Tip14 = Tip(header: "😴", title: "If you have trouble sleeping, avoid naps, especially in the afternoon", body: "Power napping may help you get through the day, but if you find that you can't fall asleep at bedtime, eliminating even short catnaps may help." , sourceName: "National Sleep Foundation", sourceURL: "https://www.sleepfoundation.org/articles/healthy-sleep-tips", sponsorLogo: "", sponsorURL: "")
...
//WEEK 3
//SUN
let weekendNow11to14Tip16 = Tip(header: "☀️", title: "Reduce sun exposure between 10 a.m. and 4 p.m. Skin cancer is the most common form of cancer in the US.", body: "Limiting exposure to the sun is the first line of defense against skin cancer. If you have to be outside during this time: \n\n• Work in the shade \n\n• Apply (and reapply) sunscreen n\n• Wear a wide-brimmed hat that protects your face and neck", sourceName: "Raleigh Medical Group", sourceURL: "https://www.raleighmedicalgroup.com/blog/entryid/185/skin-cancer-prevention", sponsorLogo: "", sponsorURL: "")
...
//SAT
let weekendNow11to14Tip20  = Tip(header: "☀️", title: "Lower your risk of skin cancer: Reduce sun exposure between 10 a.m. and 4 p.m.", body: "Having 5+ sunburns during your lifetime doubles your risk of melanoma, the deadliest form of skin cancer. If you have to be outside during this time: \n\n• Work in the shade \n\n• Apply (and reapply) sunscreen \n\n• Wear a wide-brimmed hat that protects your face and neck", sourceName: "Raleigh Medical Group", sourceURL: "https://www.raleighmedicalgroup.com/blog/entryid/185/skin-cancer-prevention", sponsorLogo: "", sponsorURL: "")
...
//WEEK 2
//SUN
let weekendNow14to16TipArray2 = [weekendNow14to16Tip8, weekendNow14to16Tip9, weekendNow14to16Tip10, weekendNow14to16Tip3]//WIP
let weekendNow14to16Topic2 = Topic(title: weekendNow14to16Title, icon: weekendNow14to16Icon, tip: weekendNow14to16TipArray2)
//SAT
let weekendNow14to16TipArray3 = [weekendNow14to16Tip12, weekendNow14to16Tip13, weekendNow14to16Tip14, weekendNow14to16Tip7]//WIP
...
let sundayNow17to20Tip1 = Tip(header: "🚰", title: "Drink water now. Drinking water may reduce cancer risk", body: "Staying hydrated can reduce risk of colon cancer by 45%, bladder cancer by 50%, and possibly reduce breast cancer risk too." , sourceName: "Shape", sourceURL: "https://www.shape.com/healthy-eating/healthy-drinks/6-reasons-drinking-water-helps-solve-any-problem", sponsorLogo: "TBD", sponsorURL: "www.test.com")
...
//WEEK 2
//SUN
let sundayNow17to20TipArray2 = [weekendNow17to20Tip0, weekendNow17to20Tip1, sundayNow17to20Tip2, sundayNow17to20Tip3]
let sundayNow17to20Topic2 = Topic(title: weekendNow17to20Title, icon: weekendNow17to20Icon, tip: sundayNow17to20TipArray2)
//SAT
let saturdayNow17to20TipArray3 = [weekendNow17to20Tip2, saturdayNow17to20Tip1, saturdayNow17to20Tip2, saturdayNow17to20Tip3]
...
let sunday21to24Tip8 = Tip(header: "📖", title: "Your body needs time to shift into sleep mode, so spend the last hour before bed doing a calming activity such as reading", body: "Electronic devices can make it hard to fall asleep, because the particular type of light emanating from the screens of these devices is activating to the brain. If you have trouble sleeping, avoid electronics before bed or in the middle of the night." , sourceName: "National Sleep Foundation", sourceURL: "https://www.sleepfoundation.org/articles/healthy-sleep-tips", sponsorLogo: "", sponsorURL: "")
...
let weekdayNow5to8Tip29 = Tip(header: "🍳", title: "Eat a high-protein breakfast because it reduces junk food cravings later today", body: "Study: Eating a high-protein breakfast was associated with increased feelings of fullness and a reduced desire to eat over the course of the entire day. \n\nParticipants who ate 35 grams of protein in the morning snacked less on fatty foods in the evening, as compared to those who ate cereal or nothing in the morning." , sourceName: "The Atlantic", sourceURL: "https://www.theatlantic.com/health/archive/2013/03/study-eat-protein-in-the-morning/274417/", sponsorLogo: "", sponsorURL: "")
...
// THU (WIP)
let weekdayNow5to8TipArray8 = [weekdayNow5to8Tip32, weekdayNow5to8Tip3, weekdayNow5to8Tip4, weekdayNow5to8Tip5]//WIP
let weekdayNow5to8Topic8 = Topic(title: weekdayNow5to8Title, icon: weekdayNow5to8Icon, tip: weekdayNow5to8TipArray8)

// FRI (WIP)
let weekdayNow5to8TipArray9 = [weekdayNow5to8Tip33, weekdayNow5to8Tip6, weekdayNow5to8Tip7, weekdayNow5to8Tip27]//WIP
...
let wednesdayNow9to11Week2Tip3 = Tip(header: "", title: "Millionaire habit: Write a to-do list for today", body: "Those who maintain both a calendar and to-do list are 289% more likely to be millionaires, as compared with those who have no real set schedule, survey finds." , sourceName: "CNBC", sourceURL: "https://www.cnbc.com/2017/04/07/7-rich-habits-of-highly-successful-people.html", sponsorLogo: "", sponsorURL: "")
...
// WED (WIP)
let weekdayNow9to11TipArray7 = [wednesdayNow9to11Week2Tip1, wednesdayNow9to11Week2Tip2, weekdayNow9to11Tip10, weekdayNow9to11Tip11]
...
let weekdayNow14to16Tip13 = Tip(header: "😀", title: "Build a habit of confidence: Every time you walk through a doorway, remember to stand up, put your chin up, put your shoulders back, and smile", body: "It's called the doorway drill. If you do that through every doorway throughout the day, you’re going to create a habit where your default body language and non-verbal communication is open, upright and positive." , sourceName: "The Unbeatable Mind Podcast", sourceURL: "https://unbeatablemind.com/jordan-harbinger/", sponsorLogo: "TBD", sponsorURL: "www.test.com")
...
let wednesday17to20Week1Tip3 = Tip(header: "📵", title: "Increase your happiness by not using technology in your free time", body: "Researchers found that teens who spent more time on the internet, playing computer games, on social media, texting, using video chat or watching TV were less happy. \n\nHowever, teens who spent more time seeing their friends in person, exercising, playing sports, attending religious services, reading or even doing homework were happier." , sourceName: "Quartz", sourceURL: "https://qz.com/1190151/why-am-i-unhappy-a-new-study-explains-americas-unhappiness-epidemic/", sponsorLogo: "", sponsorURL: "")
...
let thursday17to20Week1Tip3 = Tip(header: "🤓", title: "Use your freetime to \"be seen as a recognized expert\" within your industry", body: "Attend industry events, enroll in a class or specialized certification program, blog on LinkedIn, or take on a leadership role in a relevant professional organization. \n\nThis will help you earn a raise, get promoted, or find a better job." , sourceName: "Havard Business Review", sourceURL: "https://hbr.org/2018/02/how-to-increase-your-influence-at-work", sponsorLogo: "", sponsorURL: "")
...
let weekdayNow17to20Topic1 = Topic(title: weekdayNow17to18Title, icon: weekdayNow17to18Icon, tip: weekdayNow17to20TipArray1)
//WED
...
let weekdayNow17to20Topic2 = Topic(title: weekdayNow17to18Title, icon: weekdayNow17to18Icon, tip: weekdayNow17to20TipArray2)
...
let weekdayNow17to20Topic3 = Topic(title: weekdayNow17to18Title, icon: weekdayNow17to18Icon, tip: weekdayNow17to20TipArray3)

//FRI
let weekdayNow17to20TipArray4 = [friday17to20Week1Tip1, friday17to20Week1Tip2, friday17to20Week1Tip3, friday17to20Week1Tip4]
let weekdayNow17to20Topic4 = Topic(title: weekdayNow17to18Title, icon: weekdayNow17to18Icon, tip: weekdayNow17to20TipArray4)

//WEEK 2
//MON
let weekdayNow17to20TipArray5 = [monday17to20Week2Tip1, monday17to20Week1Tip2, monday17to20Week2Tip3, monday17to20Week2Tip4]
let weekdayNow17to20Topic5 = Topic(title: weekdayNow17to18Title, icon: weekdayNow17to18Icon, tip: weekdayNow17to20TipArray5)
//TUE
...
let weekdayNow17to20Topic6 = Topic(title: weekdayNow17to18Title, icon: weekdayNow17to18Icon, tip: weekdayNow17to20TipArray6)
//WED
let weekdayNow17to20TipArray7 = [wednesday17to20Week2Tip1, wednesday17to20Week2Tip2, wednesday17to20Week2Tip3, wednesday17to20Week2Tip4]
let weekdayNow17to20Topic7 = Topic(title: weekdayNow17to18Title, icon: weekdayNow17to18Icon, tip: weekdayNow17to20TipArray7)

//THU
let weekdayNow17to20TipArray8 = [thursday17to20Week2Tip1, thursday17to20Week2Tip2, thursday17to20Week2Tip3, thursday17to20Week2Tip4]
let weekdayNow17to20Topic8 = Topic(title: weekdayNow17to18Title, icon: weekdayNow17to18Icon, tip: weekdayNow17to20TipArray8)
...
let weekdayNow17to20Topic9 = Topic(title: weekdayNow17to18Title, icon: weekdayNow17to18Icon, tip: weekdayNow17to20TipArray9)
...
let weekdayNow19to20TipArray1 = [weekday19to20Tip9, weekday19to20Tip10, weekday19to20Tip11, weekday19to20Tip12]
let weekdayNow19to20Topic1 = Topic(title: weekdayNow19to20Title, icon: weekdayNow19to20Icon, tip: weekdayNow19to20TipArray1)

let weekdayNow19to20TipArray2 = [weekday19to20Tip13, weekday19to20Tip14, weekday19to20Tip3, weekday19to20Tip4]
let weekdayNow19to20Topic2 = Topic(title: weekdayNow19to20Title, icon: weekdayNow19to20Icon, tip: weekdayNow19to20TipArray2)

let weekdayNow19to20TipArray3 = [weekday19to20Tip12, weekday19to20Tip11, weekday19to20Tip10, weekday19to20Tip9]
let weekdayNow19to20Topic3 = Topic(title: weekdayNow19to20Title, icon: weekdayNow19to20Icon, tip: weekdayNow19to20TipArray3)

let weekdayNow19to20TipArray4 = [weekday19to20Tip13, weekday19to20Tip10, weekday19to20Tip4, weekday19to20Tip3]
