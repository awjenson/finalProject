...
func startupTopics() -> Topics {
    ...
    case 0:
        //Idea
        selectedTopic = Topics(title: "Startup", icon: Constants.Icon.sideHustle, topics: [startupIdeaTopic, startupEarlyQuoteTopic, startupHabitTopic])
    case 1:
        //MVP
        selectedTopic = Topics(title: "Startup", icon: Constants.Icon.sideHustle, topics: [startupMVPTopic, startupEarlyQuoteTopic, startupHabitTopic])
    case 2:
        //Beta
        selectedTopic = Topics(title: "Startup", icon: Constants.Icon.sideHustle, topics: [startupBetaTopic, startupEarlyQuoteTopic, startupHabitTopic])
    case 3:
        //10+ Users
        selectedTopic = Topics(title: "Startup", icon: Constants.Icon.sideHustle, topics: [startup10CustomersTopic, startupLaterQuoteTopic, startupHabitTopic])
...
let weekendNow5to8Tip23 = Tip(header: "Daily Habit 🗓", title: "Do 1+ hour a day of “deep work.” Close your browser or phone.", body: "Real progress requires deep work of intense concentration and focus. \n\nIf you don’t make time for deep work each day it won’t happen." , sourceName: "Ryan Holiday", sourceURL: "https://ryanholiday.net/13-life-changing-habits-to-try-and-do-every-single-day/", doneType: "", buyURL: "")
...
let weekendNow11to13Tip21 = Tip(header: "Live Longer 👨‍👨‍👧‍👦", title: "Increase your social connections: \n• Family \n• Friends \n• Romantic partner \n• Club membership \n• Volunteering", body: "Research: People with adequate social relationships have a 50% greater likelihood of survival compared to those with poor or insufficient social relationships. \n\nThe magnitude of this effect is comparable with quitting smoking.", sourceName: "PLOS Medicine", sourceURL: "https://journals.plos.org/plosmedicine/article?id=10.1371/journal.pmed.1000316#pmed-1000316-g006", doneType: "", buyURL: "")
let weekendNow11to13Tip22 = Tip(header: "Live Longer 🧘‍♀️", title: "Enroll in a yoga class", body: "Yoga helps increase balance, strengthens all muscle groups, increases flexibility, is good for your joints, and can lessen lower back pain. \n\nIt may also provide the same kind of social support and spiritual centering that religions do. \n\nIt's recommended to practice it at least twice weekly.", sourceName: "The Blue Zones: 9 Lessons For Living Longer", sourceURL: "https://www.amazon.com/Blue-Zones-Lessons-Living-Longest/dp/1426207557", doneType: "", buyURL: "")
let weekendNow11to13Tip23 = Tip(header: "Live Smarter 🤓", title: "Don't do too many chores on the weekend", body: "Chores expand to fill the available space. If you do them on weekdays, you’ll spend less time doing chores simply because you have less time." , sourceName: "Fast Company", sourceURL: "https://www.fastcompany.com/3015285/6-surprising-tips-to-cut-household-chores-in-half", doneType: "TBD", buyURL: "www.test.com")
...
let weekendNow11to13Tip26 = Tip(header: "Increase Happiness ☀️", title: "Moderate sunlight exposure helps improve your mood by boosting the serotonin levels in your body", body: "Also known as the 'happiness hormone', it puts you in a calm mood. \n\nSunlight also decreases the risk of depression in those at risk of seasonal affective disorder (SAD) during the winter months.", sourceName: "Forbes", sourceURL: "https://www.forbes.com/sites/nomanazish/2018/02/28/why-sunlight-is-actually-good-for-you/#5944743c5cd9", doneType: "", buyURL: "")
...
//FRI
let friday0to4Tip1 = Tip(header: "Sleep Better 😴", title: "Avoid alcohol as a way to fall asleep", body: "Sometimes people use alcohol as a sedative, but it's not good for your sleep. \n\nAs alcohol metabolizes, it actually has a rebound effect and wakes you up.", sourceName: "U.S. News", sourceURL: "https://health.usnews.com/health-news/health-wellness/articles/2014/02/11/healthy-tips-for-night-shift-workers", doneType: "", buyURL: "")
...
// WEEK 1
// MON
let weekdayNow5to8Tip0 = Tip(header: "Millionaire Habit 💰", title: "Steve Jobs asked himself this question each morning...", body: "\"I looked in the mirror every morning and asked myself: \"If today were the last day of my life, would I want to do what I am about to do today?\" And whenever the answer has been no for too many days in a row, I know I need to change something.\"" , sourceName: "FastCompany", sourceURL: "https://www.fastcompany.com/3033652/the-morning-routines-of-the-most-successful-people", doneType: "TBD", buyURL: "www.test.com")
...
let weekdayNow9to11Tip14 = Tip(header: "Tired? ☀️", title: "Get as much sunlight as you can", body: "The sun, unlike most lightbulbs, emits light that covers a wide range of the color spectrum. \n\nWhen these extra wavelengths hit your eyes, they signal your brain to stop producing sleep hormones and start producing alertness hormones.", sourceName: "When: The Scientific Secrets of Perfect Timing", sourceURL: "https://www.amazon.com/gp/product/B072Q985YX/", doneType: "", buyURL: "")
let weekdayNow9to11Tip15 = Tip(header: "Increase Productivity 🤓", title: "Take shorter, more frequent walking breaks throughout the day 🚶‍♀️", body: "Study: Hourly 5-minute walking breaks boosted energy levels, sharpened focus, improved mood throughout the day, and reduced feelings of fatigue in the late afternoon. \n\nShorter, more frequent breaks were more effective than a single 30-minute walking break.", sourceName: "When: The Scientific Secrets of Perfect Timing", sourceURL: "https://www.amazon.com/gp/product/B072Q985YX/", doneType: "", buyURL: "")

// FRI
let weekdayNow9to11Tip16 = Tip(header: "Increase Productivity 🤓", title: "Drink 6-8 glasses of water throughout the day 🚰", body: "Being even slightly dehydrated will make you tired and lower your concentration. \n\nDon’t wait until you feel thirsty before drinking either – by the time thirst kicks in you are already dehydrated.", sourceName: "Weight Loss Resources", sourceURL: "https://www.weightlossresources.co.uk/diet/healthy_eating/beat-afternoon-energy-slump.htm", doneType: "", buyURL: "")
let weekdayNow9to11Tip17 = Tip(header: "Prevent Weight Gain ☀️", title: "Get at least 20 to 30 minutes of sunlight light before noon", body: "Not getting enough light before noon disturbs your internal body clock, which is known to alter metabolism and lead to weight gain. \n\nStudy: Morning light exposure accounted for about 20% of a person’s BMI.", sourceName: "Northwestern University", sourceURL: "https://news.northwestern.edu/stories/2014/04/morning-rays-keep-off-the-pounds", doneType: "TBD", buyURL: "www.test.com")
...
let weekdayNow11to14Tip33 = Tip(header: "Live Longer 👩‍⚕️", title: "Call your doctor and schedule your yearly checkup 📞🗓", body: "Study: Life expectancy decreases by 2 years for each chronic condition a person has. \n\nMost insurances cover a yearly physical. If you're not going, you're wasting free money, and putting yourself in danger.", sourceName: "Eat This, Not That!", sourceURL: "https://www.eatthis.com/doctors-secrets-longer-life/", doneType: "", buyURL: "")

let weekdayNow11to14Tip34 = Tip(header: "Increase Productivity 🤓", title: "Study: Increase productivity up to 15% by decorating your office with plants or pictures of your family or pet", body: "Seeing plants around you can improve morale, increase satisfaction with your work, and make you more patient. \n\nSet your screensaver or web browser to display nature images." , sourceName: "Inc.", sourceURL: "https://www.inc.com/john-rampton/15-ways-to-increase-productivity-at-work.html", doneType: "TBD", buyURL: "www.test.com")


//FRI
let weekdayNow11to14Tip35 = Tip(header: "Increase Confidence 💪🪑", title: "DO: Sit in an upright posture. \nDON'T Sit in a slumped posture.", body: "Study: Upright participants reported higher self-esteem, better mood, and lower fear, compared to slumped participants. \n\nSitting upright may help build resilience to stress.", sourceName: "American Psychological Association", sourceURL: "https://psycnet.apa.org/record/2014-37739-001", doneType: "", buyURL: "")
...
let friday17to18Week2Tip3 = Tip(header: "Live Longer", title: "Exercise for 15 minutes per day 🏋️‍♀️🏃‍♀️", body: "Study: Compared with individuals in the inactive group, those who exercised for 15 min a day had a 14% reduced risk of premature death, and had a 3 year longer life expectancy. \n\nFor every additional 15 min of daily exercise beyond the minimum amount of 15 min a day further decreased their risk of premature death by 4%.", sourceName: "The Lancet", sourceURL: "https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(11)60749-6/fulltext", doneType: "", buyURL: "")
