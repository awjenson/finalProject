...
//FRI
let weekdayNow11to14Tip35 = Tip(header: "Increase Confidence 💪", title: "Having an upright posture in the face of stress maintains: \n\n• Positive self-esteem \n• Reduces negative mood \n• Increases positive mood", body: "Study: Upright participants reported higher self-esteem, better mood, and lower fear, compared to slumped participants. \n\nSitting upright may be a simple behavioral strategy to help build resilience to stress.", sourceName: "American Psychological Association", sourceURL: "https://psycnet.apa.org/record/2014-37739-001", doneType: "", buyURL: "")
