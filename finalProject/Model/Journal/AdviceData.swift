...
struct AdviceData {
    ...
    static let am1Tip1 = JournalTip(title: "", body: "", sourceName: "", sourceURL: "")
    ...
    static let pm1 = JournalQuote(quote: "\"Without reflection we go blindly on our way, creating more unintended consequences, and failing to achieve anything useful.\"", source: "Margaret J. Wheatley")

    static let pm1Tip1 = JournalTip(title: "", body: "", sourceName: "", sourceURL: "")
    ...
    static let am2 = JournalQuote(quote: "\"The key to growth is the introduction of higher dimensions of consciousness into our awareness.\"", source: "Lao Tzu")

    static let am2Tip1 = JournalTip(title: "", body: "", sourceName: "", sourceURL: "")
    ...
    static let pm2 = JournalQuote(quote: "\"As we grow in our consciousness, there will be more compassion and more love, and then the barriers between people, between religions, between nations will begin to fall.\"", source: "Ram Dass")

    static let pm2Tip1 = JournalTip(title: "", body: "", sourceName: "", sourceURL: "")
    ...
    static let am3 = JournalQuote(quote: "\"Self awareness is the ability to take an honest look at your life without any attachment to it being right or wrong, good or bad.\"", source: "Debbie Ford")

    static let am3Tip1 = JournalTip(title: "", body: "", sourceName: "", sourceURL: "")
    ...
    static let pm3 = JournalQuote(quote: "\"I think self-awareness is probably the most important thing towards being a champion.\"", source: "Billie Jean King")

    static let pm3Tip1 = JournalTip(title: "", body: "", sourceName: "", sourceURL: "")
    ...
    static let pm3Tips1 = [pm3Tip1, pm3Tip2]

    static let am4 = JournalQuote(quote: "\"Whenever you are angry, be assured that it is not only a present evil, but that you have increased a habit.\"", source: "Epictetus")

    static let am4Tip1 = JournalTip(title: "", body: "", sourceName: "", sourceURL: "")
    ...
    static let pm4Tip1 = JournalTip(title: "", body: "", sourceName: "", sourceURL: "")
    ...
    static let am5 = JournalQuote(quote: "\"You are the average of the five people you spend the most time with.\"", source: "Jim Rohn")

    static let am5Tip1 = JournalTip(title: "", body: "", sourceName: "", sourceURL: "")
    ...
    static let pm5 = JournalQuote(quote: "\"When you think everything is someone else's fault, you will suffer a lot. When you realize that everything springs only from yourself, you will learn both peace and joy.\"", source: "The 14th Dalai Lama")

    static let pm5Tip1 = JournalTip(title: "", body: "", sourceName: "", sourceURL: "")
    ...
    static let am6 = JournalQuote(quote: "\"Wisdom tends to grow in proportion to one’s awareness of one’s ignorance.\"", source: "Anthony de Mello")

    static let am6Tip1 = JournalTip(title: "", body: "", sourceName: "", sourceURL: "")
    ...
    static let pm6 = JournalQuote(quote: "\"Awareness is a key ingredient in success. If you have it, teach it, if you lack it, seek it.\"", source: "Michael B. Kitson")

    static let pm6Tip1 = JournalTip(title: "", body: "", sourceName: "", sourceURL: "")
    ...
    static let am7 = JournalQuote(quote: "\"Refuse to be average. Let your heart soar as high as it will.\"", source: "A. W. Tozer")

    static let am7Tip1 = JournalTip(title: "", body: "", sourceName: "", sourceURL: "")
    ...
    static let pm7 = JournalQuote(quote: "\"The awakening of consciousness is the next evolutionary step for mankind.\"", source: "Eckhart Tolle")

    static let pm7Tip1 = JournalTip(title: "", body: "", sourceName: "", sourceURL: "")
    ...
    static let depressedTip1 = JournalTip(title: "Tips to help you feel better:", body: "Try to follow a daily routine to get back on track, exercise will release feel-good chemicals, eat healthy foods, go to bed and get up at the same time every day, challenge your negative thoughts with logical questioning, help others, and do something that you enjoy (watch a movie, walk in nature, or spend time with friends).", sourceName: "WebMD", sourceURL: "https://www.webmd.com/depression/features/natural-treatments#3")
    ...
    static let depressed0Tips1 = [depressedTip1, depressedTip2]
    ...
    static let boreTip1 = JournalTip(title: "Tip:", body: "Chances are you feel trapped and imprisoned by your inability to grab onto anything that interests you. Tasks that are too easy are boring. See boredom as a \"call to action\". Enter a state of flow by doing activities that are both challenging and enjoyable.", sourceName: "Psychology Today", sourceURL: "https://www.psychologytoday.com/us/blog/making-change/201507/how-beat-boredom")
    static let boreTip2 = JournalTip(title: Constants.Header.watch, body: "WHEN YOU FEEL STUCK IN LIFE - NEW Motivational Video", sourceName: "YouTube", sourceURL: "https://www.youtube.com/watch?v=u6I-5B-80f4")

    static let bore0Tips1 = [boreTip1, boreTip2]
    ...
    static let goodTip1 = JournalTip(title: "Practice gratitude because it's strongly associated with greater happiness and health.", body: "Thank someone, count your blessings, pray, keep a gratitude journal. One study found that middle-aged divorced women who kept gratitude journals were no more satisfied with their lives than those who did not.", sourceName: "Harvard Health Publishing", sourceURL: "https://www.health.harvard.edu/healthbeat/giving-thanks-can-make-you-happier")
    ...
    static let good0Tips1 = [depressedTip1, depressedTip2]
    ...
    static let greatTip1 = JournalTip(title: "What are you thankful for?", body: "Research finds that practicing gratitude has many benefits: leads to more relationships, improves physical and psychological health, increases empathy and self-esteem, and reduces aggression and stress.", sourceName: "Forbes", sourceURL: "https://www.forbes.com/sites/amymorin/2014/11/23/7-scientifically-proven-benefits-of-gratitude-that-will-motivate-you-to-give-thanks-year-round/#16c4850f183c")
    ...
    static let stressedTip1 = JournalTip(title: "Researched ways to de-stress right now: ", body: "Breathe deeply, go for a walk, visualize a peaceful forest or beach, list to classical music, watch a funny video, call a friend, or even turn off your phone.", sourceName: "Huffington Post", sourceURL: "https://www.huffingtonpost.com/2015/09/06/stress-relief-that-works_n_3842511.html")
...
//
    ...
    static let proudTip1 = JournalTip(title: "Feeling proud? Try a practice used by a former Navy SEAL, David Goggins, called the \"cookie jar\". ", body: "Your cookie jar contains all the and failures in your life that you came back from. Then, whenever you face a challenge, you pull out a cookie — a memory that reminds you of a time that you did make it through that tough situation.", sourceName: "Big Think", sourceURL: "https://bigthink.com/videos/david-goggins-to-win-in-life-win-the-war-in-your-mind-navy-seal")
    ...
    static let lonelyTip1 = JournalTip(title: "Science-backed tips to reduce loneliness:", body: "Remember we all feel lonely sometimes (one in five Americans suffer from loneliness), accept your need for social connection (humans are social beings), listen to music, do something creative, work in a social setting (cafe or co-working space), call, text, or meetup with a friend, avoid using social media (scrolling mindlessly makes us lonelier), make eye contact with people, and be kind to strangers.", sourceName: "Reader's Digest", sourceURL: "https://www.rd.com/health/conditions/how-to-not-feel-lonely/")
    ...
    static let calmTip1 = JournalTip(title: "Tip to stay calm like a Navy SEAL", body: "Navy SEALs face some of the most difficult situations any human could encounter. To stay calm they practice box-breathing: Breathe in for four seconds. Hold air in your lungs for four seconds. Exhale for four seconds. Hold your breath, lungs emptied, for four seconds.", sourceName: "Inc.", sourceURL: "https://www.inc.com/melody-wilding/beat-stress-like-a-navy-seal-with-this-ridiculousl.html")
