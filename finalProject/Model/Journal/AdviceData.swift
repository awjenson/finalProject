...
struct AdviceData {
    ...
    static let am0 = JournalAdvice(quote: "\"Those who are unaware they are walking in darkness will never seek the light.\"", source: "Bruce Lee", question: "What are two fears in your life?", description: "MORNING MOTIVATION - How Successful People Start Their Day", time: "5 min", url: "https://www.youtube.com/watch?v=iLNyiaAscQ0")

    static let pm0 = JournalAdvice(quote: "\"Without reflection we go blindly on our way, creating more unintended consequences, and failing to achieve anything useful.\"", source: "Margaret J. Wheatley", question: "When do I feel most alive?", description: "Top 10 - Most Epic Motivational Speeches", time: "16 min", url: "https://www.youtube.com/watch?v=imB8rVYjMXA")

    static let am1 = JournalAdvice(quote: "\"The key to growth is the introduction of higher dimensions of consciousness into our awareness.\"", source: "Lao Tzu", question: "What makes me depressed?", description: "Wake Up Early|End Laziness|Motivational Speech Compilation", time: "42 min", url: "https://www.youtube.com/watch?v=2CYDgcE13PY")

        static let pm1 = JournalAdvice(quote: "\"As we grow in our consciousness, there will be more compassion and more love, and then the barriers between people, between religions, between nations will begin to fall.\"", source: "Ram Dass", question: "What is one of my best memories?", description: "DREAM BIG - Best Motivational Video Speeches Compilation", time: "22 min", url: "https://www.youtube.com/watch?v=5n_OBOdDdtY")

    static let am2 = JournalAdvice(quote: "\"Self awareness is the ability to take an honest look at your life without any attachment to it being right or wrong, good or bad.\"", source: "Debbie Ford", question: "When was a last time that I lost control of my emotions?", description: "MORNING MOTIVATION - Start Your Day Positively!", time: "12 min", url: "https://www.youtube.com/watch?v=vPMQdVdR0gw")

    static let pm2 = JournalAdvice(quote: "\"I think self-awareness is probably the most important thing towards being a champion.\"", source: "Billie Jean King", question: "What daily acitivies add value to my life?", description: "MORNING MOTIVATION - Start Your Day Positively!", time: "12 min", url: "https://www.youtube.com/watch?v=vPMQdVdR0gw")

    static let am3 = JournalAdvice(quote: "\"Whenever you are angry, be assured that it is not only a present evil, but that you have increased a habit.\"", source: "Epictetus", question: "What habits do not add value to my life?", description: "MORNING MOTIVATION - What Successful People Do In the First 8 Minutes of Their Morning", time: "7 min", url: "https://www.youtube.com/watch?v=5diEq1gTE4Y")

    static let pm3 = JournalAdvice(quote: "\"Be mindful of your self talk. It's a conversation with the universe.\"", source: "Davide James Lees", question: "What is one negative thought that you have about yourself?", description: "WINNING PSYCHOLOGY - New Motivational Videos Compilation", time: "32 min", url: "https://www.youtube.com/watch?v=ZNmdEau_JNM")

    static let am4 = JournalAdvice(quote: "\"You are the average of the five people you spend the most time with.\"", source: "Jim Rohn", question: "Who brings negativity into your life?", description: "MORNING MOTIVATION: 5 Min in The Morning Can Change Your Entire Day!", time: "5 min", url: "https://www.youtube.com/watch?v=yPq5IAf_97w")

    static let pm4 = JournalAdvice(quote: "\"When you think everything is someone else's fault, you will suffer a lot. When you realize that everything springs only from yourself, you will learn both peace and joy.\"", source: "The 14th Dalai Lama", question: "Who is one of your heros? And why?", description: "Best Motivational Speech Compilation EVER #12 - DECIDE TO WIN", time: "34 min", url: "https://www.youtube.com/watch?v=3jyAUQHd6IM")

    static let am5 = JournalAdvice(quote: "\"Wisdom tends to grow in proportion to one’s awareness of one’s ignorance.\"", source: "Anthony de Mello", question: "What new skills am I learning?", description: "START YOUR DAY POSITIVELY - Listen To This Every Morning for Positive Energy ", time: "18 min", url: "https://www.youtube.com/watch?v=UHnwpf8iYaI")

    static let pm5 = JournalAdvice(quote: "\"Awareness is a key ingredient in success. If you have it, teach it, if you lack it, seek it.\"", source: "Michael B. Kitson", question: "What can I say no to so I can yes to what matters?", description: "The Best Motivational Speech Compilation For Success In Life", time: "35 min", url: "https://www.youtube.com/watch?v=pH-9j4MtuIQ")

    static let am6 = JournalAdvice(quote: "\"Refuse to be average. Let your heart soar as high as it will.\"", source: "A. W. Tozer", question: "Who improves your life?", description: "Build The Person You Want to Be - Best Motivational Videos Compilation for 2018", time: "35 min", url: "https://www.youtube.com/watch?v=PwGXhJAYdDQ")

    static let pm6 = JournalAdvice(quote: "\"The awakening of consciousness is the next evolutionary step for mankind.\"", source: "Eckhart Tolle", question: "What's one thing that I am grateful for today?", description: "WATCH THIS EVERY NIGHT - Most Motivational Speeches For Study & Success", time: "30 min", url: "https://www.youtube.com/watch?v=FfrcrrGLysU")
