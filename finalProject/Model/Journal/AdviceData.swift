...
//3
let badMoodTipAMArray3 = [badMoodTipAM12, badMoodTipAM14, badMoodTipAM1, badMoodTipAM2]
let badMoodAMTopic3 = Topic(title: badMoodTitle, icon: badMoodIcon, tip: badMoodTipAMArray3)

//4
let badMoodTipAMArray4 = [badMoodTipAM0, badMoodTipAM1, badMoodTipAM2, badMoodTipAM3]
...
//2 WIP-4
let badMoodTipDayArray6 = [badMoodTipDay8, badMoodTipDay9, badMoodTipDay10, badMoodTipDay11]
...
//5 WIP-4
let badMoodTipPMArray5 = [badMoodTipPM20, badMoodTipPM9, badMoodTipPM8, badMoodTipPM11]
...
let wealth7 = Tip(header: "🤔", title: "Warren Buffett: Invest in an S&P 500 (^GSPC) index fund like the Vanguard 500 (VOO, VFINX, VFIAX)", body: "“All you have to do is just buy a cross-section of America and then never listen to people like me or read the papers or do anything subsequently.” Warren Buffett \n\nBuffett’s recommendation for capturing this “cross-section” is to invest in an S&P 500 (^GSPC) index fund like the Vanguard 500 (VOO, VFINX, VFIAX). \n\nS&P 500 index funds have a long history of outperforming most actively managed funds, which aim to beat the index.", sourceName: "Yahoo! Finance", sourceURL: "https://finance.yahoo.com/news/warren-buffett-investment-advice-152818197.html", sponsorLogo: "", sponsorURL: "")
...
//3 (WIP 4)
let wealthTipArray3 = [wealth2, wealth3, wealth0, wealth1]
let wealthTopic3 = Topic(title: wealthTitle, icon: wealthIcon, tip: wealthTipArray3)
//4 (WIP 4)
let wealthTipArray4 = [wealth6, wealth7, wealth4, wealth5]
let wealthTopic4 = Topic(title: wealthTitle, icon: wealthIcon, tip: wealthTipArray4)
//5 (WIP 4)
let wealthTipArray5 = [wealth10, wealth11, wealth8, wealth9]
...
let confidence5 = Tip(header: "🤔", title: "Navy SEAL mental toughness technique when faced with a daunting task: \"Eat the Elephant\" one bite at a time", body: "Break down any daunting ask into immediate, bite-sized objectives. Ideally, they should fit into a 24-hour window. \n\nFocus only on completing one at a time. Avoid considering the whole.", sourceName: "Observer", sourceURL: "https://observer.com/2016/11/bulletproof-mind-6-secrets-of-mental-toughness-from-the-navy-seals/", sponsorLogo: "", sponsorURL: "")
...
//2
let jobSearch4 = Tip(header: "🤝", title: "Build and expand your network of contacts through social media and professional organizations", body: "Let friends, family, and professional contacts know that you’re looking for a job, and ask for their help in finding connections to the organizations you’re interested in. A résumé handed to the hiring manager directly from someone within the company is more likely to get noticed.", sourceName: "Forbes", sourceURL: "https://www.forbes.com/sites/jacquelynsmith/2013/03/20/10-things-to-do-while-youre-unemployed/#11534a8550ca", sponsorLogo: "", sponsorURL: "")
...
let jobSearch10 = Tip(header: "", title: "Warren Buffett's Career Advice: “I urge you to work in jobs you love. You’re out of your mind if you keep taking jobs that you don’t like because you think it’ll look good on your resume.”", body: "He continued: “Do something you enjoy. Be associated with people you like. I only work with people I like. If I could make $100 million dollars with a guy who causes my stomach to churn, I’d say no.”", sourceName: "CNBC", sourceURL: "https://www.cnbc.com/2019/08/10/warren-buffett-what-id-do-differently-to-live-a-happier-life.html", sponsorLogo: "", sponsorURL: "")
...
// (WIP 1)
let jobSearchTipArray3 = [jobSearch12, jobSearch13, jobSearch14, jobSearch7]
let jobSearchTopic3 = Topic(title: jobSearchTitle, icon: jobSearchIcon, tip: jobSearchTipArray3)
// (WIP 4)
let jobSearchTipArray4 = [jobSearch1, jobSearch2, jobSearch3, jobSearch4]
...
let filmAdvice1 = Tip(header: "", title: "Guilermo del Toro: Industry Advice", body: "Be resilient and never lose hope. It's an evolutionary business. It's going to be brutal, it's going to be horrible, it's going to merciless. And if you break, you shouldn't be making movies." , sourceName: "BFI Screen Talk: Guilermo del Toro | BFI London Film Festival 2017", sourceURL: "https://www.youtube.com/watch?v=rfbD3OBir64", sponsorLogo: "", sponsorURL: "")
let filmAdvice2 = Tip(header: "", title: "Spike Lee: Career Advice [Directing]", body: "If you did a survey of the last 25 years and looked at the first films of directors, I’d say a large percentage of those films the directors wrote that script. \n\nThat’s a big clue when talking about film. If you want to be a director, you have to write also." , sourceName: "IndieWire", sourceURL: "https://www.indiewire.com/gallery/directing-tips-filmmakers-christopher-nolan-wes-anderson-quentin-tarantino-advice/moncler-a-tribute-to-new-york-city-new-york-usa-16-nov-2016-2/", sponsorLogo: "", sponsorURL: "")
let filmAdvice3 = Tip(header: "", title: "Guilermo del Toro: Career Advice [Daily Routine]", body: "My social life is deplorable, but every day I watch one to two movies, minimum. Every day. \n\nI review more than view. I try to break down the movies that I love into elements. How does it work? Why does it work?" , sourceName: "The Craft of the Director: Guillermo del Toro, Directors Guild of America", sourceURL: "https://www.youtube.com/watch?v=FjR5bT5YYU0", sponsorLogo: "", sponsorURL: "")
...
//2
let filmAdvice8 = Tip(header: "⏳", title: "To make a great film you need three things – the script, the script and the script.", body: "- Alfred Hitchcock" , sourceName: "Industrial Scripts", sourceURL: "https://industrialscripts.com/quotes-about-screenwriting/", sponsorLogo: "", sponsorURL: "")
...
//4
let filmPreTipArray4 = [filmPre16, filmPre17, filmPre18, filmPre14]
...
//3
let screenwriting12 = Tip(header: "", title: "David O. Russell: Characters", body: "You have to love each character in some way and each character has to be loved. Even if they are the bad guys. You can hate a character, but you also have to love them." , sourceName: "The Craft of the Director: David O. Russell", sourceURL: "https://www.youtube.com/watch?v=_wDrklwynLo", sponsorLogo: "", sponsorURL: "")
let screenwriting13 = Tip(header: "", title: "Guilermo del Toro writes detailed biographies for all of his characters", body: "\"What I do for my actors, and as part of my screenwriting process, I write incredibly detailed biographies. \n\nI write down everything I know about a character. What they eat, what music they listen to, what secrets they keep.\"" , sourceName: "BFI Screen Talk: Guilermo del Toro | BFI London Film Festival 2017", sourceURL: "https://www.youtube.com/watch?v=rfbD3OBir64", sponsorLogo: "", sponsorURL: "")
let screenwriting14 = Tip(header: "", title: "Orson Welles: Adapting a book or play into a screenplay", body: "When Orson Welles wrote the screenplay for The Trial (1962 film) based on the novel of the same name by Franz Kafka, Orson re-ordered some of the book's chapters in the final screenplay. His reason for doing this was: \n\n\"Every film is an original work. A film should never be an illustration of a book or a play. It should be of itself. The picture-maker is engaged in an art form that is entirely different from literature and the theater. And so they not only have the right but the obligation to turn the work into something a little different than the author intended. If they perfectly realize it then we might as well have lantern slides and somebody with a lovely voice reading the book.\"" , sourceName: "Filming 'The Trial' [1981] (Unedited) - Rare Orson Welles Documentary", sourceURL: "https://www.youtube.com/watch?v=RbUe-bM6bXg", sponsorLogo: "", sponsorURL: "")
...
let startup2 = Tip(header: "", title: "The most common thing that kills startups is that they build something that nobody wants", body: "A good founder is someone who is comfortable disproving their own ideas. You need to prove that people will either want you product or not. \n\nThe best evidence is getting people to pay you money for your product. Telling an investor that you already have paying customers increases your chances of getting funded. \n\n- Paul Buchheit, Y Combinator Partner and the creator of GMail" , sourceName: "Stanford University", sourceURL: "https://www.youtube.com/watch?v=rmFyatXeMCY", sponsorLogo: "", sponsorURL: "")
let startup3 = Tip(header: "", title: "Pitching to a VC: Have 15-20 slides in your slide deck", body: "The 8 things that your presentation should cover (1-2 slides per topic): \n\n1. Vision Statement \n2. Executive Summary \n3. Problem description \n4. Product solution \n5. Go-to Market plan \n6. Competitive landscape \n7. Operating plan \n8. Financing details \n\nIn a 60-minute pitch meeting, half of it will be spent on your slides and the other half will be spent answering the VCs questions. The key to your first meeting is not to get a term sheet but to get a second meeting. \n\n- Tom Fountain, former Principal at Mayfield Fund", sourceName: "Stanford Graduate School of Business", sourceURL: "https://www.youtube.com/watch?v=PyG5k0QtKOQ", sponsorLogo: "", sponsorURL: "")

//1
let startup4 = Tip(header: "", title: "Your users are your guidepost. And the way you stay on the right path in the early stages of a startup is to build stuff and talk to users. And nothing else.", body: "- Jessica Livingston \n\nCo-founder of Y Combinator", sourceName: "Y Combinator", sourceURL: "https://ycombinator.wpengine.com/how-not-to-fail/", sponsorLogo: "", sponsorURL: "")
...
let startup25 = Tip(header: "", title: "Pre-product market fit – do things that don’t scale. Airbnb is a great example of this technique.", body: "Many startup advisors persuade startups to scale way too early. \n\nThis will require the building of technology and processes to support that scaling, which, if premature, will be a waste of time and effort. This strategy often leads to failure and even startup death. \n\nRather, Y Combinator tell startups to get their first customer by any means necessary, even by manual work that couldn’t be managed for more than ten, much less 100 or 1000 customers. \n\nIn the beginning, founders are still trying to figure out what needs to be built and the best way to do that is talk directly to customers. \n\nFor example, the Airbnb founders originally offered to “professionally” photograph the homes and apartments of their earliest customers in order to make their listings more attractive to renters. Then, they went and took the photographs themselves. \n\nThe listings on their site improved, conversions improved, and they had amazing conversations with their customers. This was entirely unscalable, yet proved essential in learning how to build a vibrant marketplace. \n\nRemember, growth is the result of a great product not the precursor.", sourceName: "Y Combinator", sourceURL: "https://blog.ycombinator.com/ycs-essential-startup-advice/", sponsorLogo: "", sponsorURL: "")
let startup26 = Tip(header: "", title: "Y Combinator Advise: Startups can only solve one problem well at any given time", body: "When your early-stage product isn’t working it’s often tempting to immediately build new features in order to solve every problem the customer seems to have instead of talking to the customer and focusing only on the most acute problem they have. \n\nStartup founders’ intuition will always be to do more whereas usually, the best strategy is almost always to do less, really well.", sourceName: "Y Combinator", sourceURL: "https://blog.ycombinator.com/ycs-essential-startup-advice/", sponsorLogo: "", sponsorURL: "")
let startup27 = Tip(header: "", title: "VC Brad Feld insists that if you want to know if a founder will succeed, ask what they do in their free time", body: "\"What do you do on the weekends?\" is a question that Brad asks founders of companies he's looking at investing in. \n\nFormer Y Combinator partner Harj Taggar said, \"the surest sign of coming success was what a potential founder did in their spare time.\" \n\nAnd Andreessen Horowitz investor Chris Dixon has famously insisted that \"what the smartest people do on the weekend is what everyone else will do during the week in 10 years.\"" , sourceName: "Inc.", sourceURL: "https://www.inc.com/jessica-stillman/this-is-number-1-sign-a-founder-will-succeed-according-to-a-former-y-combinator-partner.html", sponsorLogo: "", sponsorURL: "")//WEEEKEND ONLY
...
// MARK: Single, AM
//0
let singleAM0 = Tip(header: "", title: "Dating Coach's Advice: Leave your house with the mindset of being open, approachable and ready to connect. Keep your face up and make eye contact with those around you.", body: "Get in physical proximity to anyone you're interested in, and initiate a 'hello.' \n\nIf you make this a practice, it will become a lot less scary and awkward.", sourceName: "Bustle", sourceURL: "https://www.bustle.com/p/the-top-ways-singles-meet-people-when-theyre-not-online-dating-8082924", sponsorLogo: "", sponsorURL: "")
...
let singleTipAMArray1 = [singleAM4, singleAM3, singleAM2, singleAM1]
let singleTopicAM1 = Topic(title: singleTitle, icon: singleIcon, tip: singleTipPMArray1)

let singleTipAMArray2 = [singleAM1, singleAM0, singleAM2, singleAM3]
let singleTopicAM2 = Topic(title: singleTitle, icon: singleIcon, tip: singleTipPMArray2)

let singleTipAMArray3 = [singleAM3, singleAM4, singleAM2, singleAM1]
...
let singleTipAMArray5 = [singleAM4, singleAM3, singleAM2, singleAM1]
let singleTopicAM5 = Topic(title: singleTitle, icon: singleIcon, tip: singleTipPMArray5)

let singleTipAMArray6 = [singleAM2, singleAM3, singleAM4, singleAM1]
...
let singleTipDayArray4 = [singleDay0, singleDay1, singleDay2, singleDay3]
...
let singlePM1 = Tip(header: "", title: "Online Dating - Study: \n• Men may want to include a photo of you with your female friends. \n• Women may want to avoid displaying photos of themself surrounded by their male friends.", body: "College-age women were more likely to rate a man as attractive if shown a photo of him surrounded by four women than if show a photo of him alone. \n\nCollege-age men were less likely to rate a woman as attractive if she was shown surrounded by four men that if she was alone. \n\nResearchers estimate that the reason for this may be evolutionary-based.", sourceName: "Connected: The Surprising Power of Our Social Networks and How They Shape Our Lives", sourceURL: "https://www.amazon.com/Connected-Surprising-Power-Social-Networks-ebook/dp/B002OFVO5Y", sponsorLogo: "", sponsorURL: "")
...
//2 WIP-4
let relationshipDayTipArray2 = [relationshipDay1, relationshipDay0, relationshipDay2, relationshipDay3]
...
//3 WIP-4
let relationshipDayTipArray6 = [relationshipDay3, relationshipDay2, relationshipDay7, relationshipDay6]
...
let relationshipPM7 = Tip(header: "", title: "Smile at each other, smile at your wife, smile at your husband, smile at your children, smile at each other - it doesn't matter who it is - and that will help you to grow up in greater love for each other.", body: "- Mother Teresa \n\nShe was an Albanian-Indian Roman Catholic nun and missionary." , sourceName: "Wonderful Quote", sourceURL: "https://www.wonderfulquote.com/a/mother-teresa-quotes", sponsorLogo: "", sponsorURL: "")
...
//3 (WIP: 3)
let relationshipPMTipArray4 = [relationshipPM16, relationshipPM17, relationshipPM18, relationshipPM3]
...
//3 (WIP: 4)
let relationshipPMTipArray6 = [relationshipPM11, relationshipPM15, relationshipPM18, relationshipPM17]
...
//WIP 1
let parentingAMTipArray2 = [parentingAMTip8, parentingAMTip9, parentingAMTip10, parentingAMTip3]
...
//WIP 4
let parentingAMTipArray6 = [parentingAMTip6, parentingAMTip5, parentingAMTip4, parentingAMTip10]
...
let parentingPMTip7 = Tip(header: "", title: "Study: Children who eat fish at least once a week sleep better and have IQ scores that are 4 points higher, on average, than those who consume fish less frequently or not at all", body: "Children should be introduced to it early on. Children should be introduced to it early on. \n\n Consumption even once a week moves a family into the \"high\" fish-eating group as defined in the study." , sourceName: "Science Daily", sourceURL: "https://www.sciencedaily.com/releases/2017/12/171221101341.htm", sponsorLogo: "", sponsorURL: "")
...
//2
let parentingPMTipArray2 = [parentingPMTip2, parentingPMTip3, parentingPMTip0, parentingPMTip1]
let parentingPMTopic2 = Topic(title: parentingTitle, icon: parentingIcon, tip: parentingPMTipArray2)
//3
let parentingPMTipArray3 = [parentingPMTip6, parentingPMTip7, parentingPMTip4, parentingPMTip5]
let parentingPMTopic3 = Topic(title: parentingTitle, icon: parentingIcon, tip: parentingPMTipArray3)
//4
let parentingPMTipArray4 = [parentingPMTip0, parentingPMTip1, parentingPMTip2, parentingPMTip3]
...
//6
let parentingPMTipArray6 = [parentingPMTip6, parentingPMTip7, parentingPMTip2, parentingPMTip3]
...
let fearQuote1 = Tip(header: "🤔", title: "FEAR - Robert Tew, Professional Athlete", body: "Until you see fear as an opportunity for growth, you won’t grow beyond your current self.", sourceName: "Good Reads", sourceURL: "https://www.goodreads.com/author/quotes/13848712.Robert_Tew?page=2", sponsorLogo: "", sponsorURL: "")



let adviceTipArray0 = [passion0, purpose0, goals0, fear0]
let adviceTopic0 = Topic(title: adviceTitle, icon: adviceIcon, tip: adviceTipArray0)

let adviceTipArray1 = [passion1, purpose1, goals1, fear0]
