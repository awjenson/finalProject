...
struct AdviceData {
    ...
    static let shy0 = JournalAdvice(quote: "Because one believes in oneself, one doesn't try to convince others. Because one is content with oneself, one doesn't need others' approval. Because one accepts oneself, the whole world accepts him or her.", source: "Lao Tzu", question: "Why do you feel \(Constants.SelectedMood.Button8)?", description: "Tony Robbins - How to Be More Confident and overcome shyness", time: "26 min", url: "https://www.youtube.com/watch?v=ikpvdDQWmXI")
    ...
    ///
    static let lost0 = JournalAdvice(quote: "Not until we are lost do we begin to understand ourselves.", source: "Henry David Thoreau", question: "Why do you feel \(Constants.SelectedMood.Button10)?", description: "WATCH WHEN YOU FEEL LOST - Motivational Video For Success In Life 2018", time: "53 min", url: "https://www.youtube.com/watch?v=V2NpcB_q2go")

    static let lonely0 = JournalAdvice(quote: "You cannot be lonely if you like the person you're alone with.", source: "Wayne Dyer", question: "Why do you feel \(Constants.SelectedMood.Button11)?", description: "The Simple Cure for Loneliness | Baya Voce | TEDxSaltLakeCity", time: "14 min", url: "https://www.youtube.com/watch?v=KSXh1YfNyVA")

    static let jealous0 = JournalAdvice(quote: "Jealousy lives upon doubts. It becomes madness or ceases entirely as soon as we pass from doubt to certainty.", source: "Francois de La Rochefoucauld", question: "Why do you feel \(Constants.SelectedMood.Button12)?", description: "An Ode to Envy | Parul Sehgal | TED Talks", time: "13 min", url: "https://www.youtube.com/watch?v=_x1qkuvUxuI")

    static let proud0 = JournalAdvice(quote: "Whether you're tall or short, or a little bigger, more curves, skinny - you just have to be proud of what you hav, and everyone is beautiful.", source: "Caroline Wozniacki", question: "Why do you feel \(Constants.SelectedMood.Button13)?", description: "The art of being yourself | Caroline McHugh | TEDxMiltonKeynesWomen", time: "26 min", url: "https://www.youtube.com/watch?v=veEQQ-N9xWU")

    static let loved0 = JournalAdvice(quote: "Let us always meet each other with smile, for the smile is the beginning of love.", source: "Mother Teresa", question: "Why do you feel \(Constants.SelectedMood.Button14)?", description: "How to love and be loved | Billy Ward | TEDxFoggyBottom", time: "18 min", url: "https://www.youtube.com/watch?v=vMeEKBaiPbg")
