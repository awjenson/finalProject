...
struct AdviceData {
    ...
    static let pm5 = JournalQuote(quote: "\"When you think everything is someone else's fault, you will suffer a lot. When you realize that everything springs only from yourself, you will learn both peace and joy.\"", source: "The 14th Dalai Lam")
