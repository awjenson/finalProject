...
struct MoodData {
    ...
    static let depressedTip6 = Hint(title: "The best ways to improve your mood", body: "Researchers who asked people to report their moods through the day found that they were happiest when relaxing, socializing, exercising, eating, doing spiritual activities, and engaging in intimate relations. So make time to do these activities more often in your day.", sourceName: "Fast Company", sourceURL: "https://www.fastcompany.com/3048975/the-scientifically-proven-way-to-have-the-best-vacation-ever")
