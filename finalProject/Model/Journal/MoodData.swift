...
////////
    ...
    static let anxietyTip5 = JournalTip(title: "Learning new things reduces anxiety, study finds", body: "In stressful situations at work, employees experienced less anxiety on days when they engaged in more learning activities at work (e.g., doing things to broaden their horizons, seeking out intellectual challenges, or learning something new) compared to other days. Learning brings us new information and knowledge that can be useful for solving near-term stressful problems; it also equips us with new skills and capabilities to address or even prevent future stressors. Learning also helps connect us to an underlying purpose of growth and development. This way, we can see ourselves as constantly improving and developing, rather than being stuck with fixed capabilities.", sourceName: "Harvard Business Review", sourceURL: "https://hbr.org/2018/09/to-cope-with-stress-try-learning-something-new")
