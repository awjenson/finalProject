...
let weekendNow17to20Tip0 = Tip(title: "Sucessful people spend time to reflect.", body: "As Socrates said, \"An unexamined life is not worth living.\" And successful people follow that philosophy, using the weekends to look back at what worked and what didn’t. By reflecting on your week, you can focus on the improvements you need to make on Monday." , sourceName: "Success.com", sourceURL: "https://www.success.com/article/10-things-exceptionally-successful-people-do-on-the-weekends", sponsorLogo: "TBD", sponsorURL: "www.test.com")
...
let weekdayNow21to24Tip4 = Tip(title: "Increase your confidence by sleeping on your back or stomach in an open position with your arms and legs outstretched.", body: "When we sleep, we also tend to wrap our arms around ourselves or lay in a fetal position, which makes us feel safe. The fetal position is when you lie on your side with your arms and legs pulled toward your stomach. This, however, is a low power position. Staying in this position throughout the night may be detrimental to our emotional state the next morning. Researchers found that the fetal position is most adopted by highly emotional and sensitive people. More than twice as many women sleep in this position compared to men. If you spend a lot of time in a low power position, it affects the way you think and feel. You may wake up feeling sensitive and vulnerable without understanding why. The ideal sleeping position is similar to a power pose in an 'X' or 'Y' position, but simply on your back or stomach instead. Lying in an open position with your arms and legs outstretched will make you feel bigger and, therefore, more powerful. You can also put your hands behind your head, which is another power pose.", sourceName: "Business Insider", sourceURL: "http://www.businessinsider.com/sleep-position-may-affect-success-2013-11", sponsorLogo: "sponsor", sponsorURL: "sponsorURL")
