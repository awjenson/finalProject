...
class NowViewController: UIViewController {
    ...
    func sunday(_ hour: Int) {
        ...
        case 0...4:
            ...
            appendSevenTopics(lateNightSnackTopic0, meditationTopic0, barTopic0, homeAMTopic0, bedtimeTopic1, journalTopic0, weekendNow0to4Topic1)
        ...
        case 14...16:
            ...
            // call function to display 9 time-based topics
            appendSevenTopics(cafePMTopic0, runningTopic0, yogaTopic0, gymTopic0, mindfulnessTopic0, groceryStoreTopic1, weekendNow14to16Topic1)
        case 17...20:
            print("Weekend, Early Evening")
            // call function to display 9 time-based topics
            appendSevenTopics(dinnerTopic0, dateTopic0, groceryStoreTopic2, barTopic0, homePMTopic0, restaurantTopic0, weekendNow17to20Topic1)
        case 21..<24:
            print("Weekend, Late evening")
            // call function to display 9 time-based topics
            appendSevenTopics(barTopic0, dateTopic1, homePMTopic0, bathroomPMTopic0, lateNightSnackTopic0, bedtimeTopic1, weekendNow21to24Topic1)
        default:
    ...
    func monday(_ hour: Int) {
        ...
        case 5...8:
            ...
            // call function to display 9 time-based topics
            appendSevenTopics(meditationTopic0, gymTopic2, journalTopic0, breakfastTopic0, cafeTopic1, commuteAMTopic0, weekday0Now5to8Topic0)
        ...
        case 11..<14:
            ...
            appendSevenTopics(workAMTopic0, lunchTopic0, afternoonSnackTopic0, breakTopic0, mindfulnessTopic1, cafePMTopic0, weekdayNow11to14Topic0)
        ...
        case 19...20:
            ...
            // call function to display 9 time-based topics
            appendSevenTopics(gymTopic1, restaurantTopic1, dinnerTopic0, dateTopic1, barTopic0, homePMTopic0, weekdayNow17to20Topic0)
        case 21..<24:
            print("Weekday, Late evening")
            // call function to display 9 time-based topics
            appendSevenTopics(barTopic0, dinnerAfter9PMTopic0, homePMTopic0, lateNightSnackTopic0, bathroomPMTopic0, bedtimeTopic1, weekdayNow21to24Topic0)
        default:
    ...
    func tuesday(_ hour: Int) {
        ...
        case 0...4:
            print("weekdayMTW, Very Early Morning")
            // call function to display 9 time-based topics
            appendSevenTopics(bedtimeTopic1, lateNightSnackTopic0, homePMTopic0, journalTopic0, meditationTopic0, mindfulnessTopic0, weekdayNow0to4Topic1)
        case 5...8:
            print("weekdayMTW, Early Morning")
            // call function to display 9 time-based topics
            appendSevenTopics(meditationTopic0, journalTopic1, gymTopic2, breakfastTopic0, cafeTopic0, commuteAMTopic0, weekday0Now5to8Topic1)

        case 9..<11:
            print("weekdayMTW, Late Morning")
            // call function to display 9 time-based topics
            appendSevenTopics(breakfastTopic0, cafeTopic1, commuteAMTopic0, workAMTopic0, mindfulnessTopic1, breakTopic0, weekdayNow9to11Topic1)

        case 11..<14:
            print("weekdayMTW, Midday")
            appendSevenTopics(workAMTopic0, lunchTopic0, afternoonSnackTopic0, breakTopic0, mindfulnessTopic0, cafeTopic0, weekdayNow11to14Topic1)
        ...
        case 16..<17:
            print("weekdayMTW, Afternoon")
            // call function to display 9 time-based topics
            appendSevenTopics(workPMTopic3, afternoonSnackTopic0, breakTopic0, commutePMTopic0, groceryStoreTopic2, happyHourTopic0, weekdayNow14to16Topic1)

        case 17...18:
            print("weekdayMTW, Early-Evening")
            appendSevenTopics(workLateTopic0, commutePMTopic0, gymTopic0, groceryStoreTopic3, dinnerTopic0, dateTopic0, weekdayNow17to20Topic1)
        case 19...20:
            print("Weekday, Evening")
            // call function to display 9 time-based topics
            appendSevenTopics(gymTopic1, restaurantTopic1, dinnerTopic0, dateTopic1, barTopic0, homePMTopic0, weekdayNow17to20Topic1)
        case 21..<24:
            print("Weekday, Late evening")
            // call function to display 9 time-based topics
    ...
    func wednesday(_ hour: Int) {
        ...
        case 9..<11:
            print("weekdayMTW, Late Morning")
            // call function to display 9 time-based topics
            appendSevenTopics(breakfastTopic0, cafeTopic0, commuteAMTopic0, workAMTopic0, mindfulnessTopic1, breakTopic0, weekdayNow9to11Topic0)

        case 11..<14:
            print("weekdayMTW, Midday")
            appendSevenTopics(workAMTopic0, lunchTopic0, afternoonSnackTopic0, breakTopic0, mindfulnessTopic0, cafeTopic1, weekdayNow11to14Topic2)
        ...
        case 21..<24:
            print("Weekday, Late evening")
            // call function to display 9 time-based topics
            appendSevenTopics(barTopic0, dinnerAfter9PMTopic0, homePMTopic0, lateNightSnackTopic0, bathroomPMTopic0, bedtimeTopic1, weekdayNow21to24Topic2)
        default:
            print("Weekday,INVALID HOUR!")
        }
    }
    ...
    func thursday(_ hour: Int) {
        ...
        case 0...4:
            ...
            // call function to display 9 time-based topics
            appendSevenTopics(bedtimeTopic1, lateNightSnackTopic0, homePMTopic0, meditationTopic0, barTopic0, dateTopic1, weekdayNow0to4Topic1)
        case 5...8:
            print("weekdayTF, Early Morning")
            // call function to display 9 time-based topics
            appendSevenTopics(homeAMTopic0, meditationTopic0, gymTopic2, journalTopic0, breakfastTopic0, commuteAMTopic0, weekday1Now5to8Topic1)
        case 9..<11:
        ...
        case 11..<14:
            ...
            appendSevenTopics(workAMTopic0, lunchTopic0, afternoonSnackTopic0, cafeTopic0, breakTopic0, mindfulnessTopic0, weekdayNow11to14Topic1)

        case 14...16:
            print("weekdayTF, Afternoon")
            // call function to display 9 time-based topics
            appendSevenTopics(workPMTopic1, afternoonSnackTopic0, cafeTopic1, breakTopic0, mindfulnessTopic0, commutePMTopic0, weekdayNow14to16Topic1)

        case 17...18:
            print("weekdayTF, Evening")
            // call function to display 9 time-based topics
            appendSevenTopics(workLateTopic0, commutePMTopic0, gymTopic0, dinnerTopic0, barTopic0, dateTopic0, weekdayNow17to20Topic1)

        case 19...20:
            print("weekdayTF, Evening")
            // call function to display 9 time-based topics
            appendSevenTopics(workLateTopic0, gymTopic1, dinnerTopic0, barTopic0, restaurantTopic0, dateTopic1, weekdayNow17to20Topic1)
        case 21..<24:
            print("weekdayTF, Late evening")
            // call function to display 9 time-based topics
            appendSevenTopics(dinnerAfter9PMTopic0, barTopic1, dateTopic0, homePMTopic0, bedtimeTopic1, lateNightSnackTopic0, weekdayNow21to24Topic3)
        default:
    ...
    func friday(_ hour: Int) {
        ...
        case 5...8:
            ...
            // call function to display 9 time-based topics
            appendSevenTopics(homeAMTopic0, meditationTopic0, gymTopic2, journalTopic1, breakfastTopic0, commuteAMTopic0, weekday1Now5to8Topic0)
        case 9..<11:
            print("weekday Fri, Late Morning")
            // call function to display 9 time-based topics
            appendSevenTopics(commuteAMTopic0, workAMTopic0, lunchTopic0, cafeTopic0, breakTopic0, mindfulnessTopic1,  weekdayNow9to11Topic0)

        case 11..<14:
            print("weekday Fri, Midday")
            appendSevenTopics(workAMTopic0, lunchTopic0, afternoonSnackTopic0, cafeTopic1, breakTopic0, mindfulnessTopic0, weekdayNow11to14Topic1)

        case 14...16:
            print("weekday Fri, Afternoon")
            // call function to display 9 time-based topics
            appendSevenTopics(workPMTopic2, afternoonSnackTopic0, cafeTopic0, breakTopic0, mindfulnessTopic1, commutePMTopic0, weekdayNow11to14Topic0)

        case 17...18:
            print("weekday Fri, Evening 5-6PM")
            // call function to display 9 time-based topics
            appendSevenTopics(commutePMTopic0, gymTopic0, happyHourTopic0, restaurantTopic1, dinnerTopic0, homePMTopic0, weekdayNow17to20Topic1)
        case 19...20:
            print("weekday Fri, Evening 7-8PM")
            // call function to display 9 time-based topics
            appendSevenTopics(gymTopic1, dinnerTopic0, restaurantTopic1, barTopic1, dateTopic1, homePMTopic0, weekdayNow17to20Topic0)
        case 21..<24:
            print("weekdayTF, Late evening 9-12PM")
            // call function to display 9 time-based topics
            appendSevenTopics(dinnerAfter9PMTopic0, barTopic0, dateTopic0, homePMTopic0, lateNightSnackTopic0, bedtimeTopic0, weekdayNow21to24Topic2) // Update Now to Friday
        default:
            print("weekdayTF,INVALID HOUR!")
        }
    }
    ...
    func saturday(_ hour: Int) {
        ...
        case 5...8:
            print("Weekend, Early Morning")
            // call function to display 9 time-based topics
            appendSevenTopics(meditationTopic0, journalTopic1, gymTopic1, runningTopic0, breakfastTopic0, homeAMTopic0, weekendNow5to8Topic0)

        case 9..<11:
            print("Weekend, Late Morning")
            // call function to display 9 time-based topics
            appendSevenTopics(gymTopic2, yogaTopic0, runningTopic0, cafeTopic1, breakfastTopic0, brunchTopic0, weekendNow9to11Topic0)
        ...
        case 14...16:
            print("Weekend, Afternoon")
            // call function to display 9 time-based topics
            appendSevenTopics(cafeTopic0, runningTopic0, gymTopic1, groceryStoreTopic1, dateTopic1, barTopic0, weekendNow14to16Topic0)
        case 17...20:
            print("Weekend, Early Evening")
            // call function to display 9 time-based topics
        ...
        case 21..<24:
            print("Weekend, Late evening")
            // call function to display 9 time-based topics
            appendSevenTopics(barTopic1, dateTopic1, homePMTopic0, bathroomPMTopic0, lateNightSnackTopic0, bedtimeTopic0, weekendNow21to24Topic0)
        default:
            print("Weekend,INVALID HOUR!")
        }
    }
